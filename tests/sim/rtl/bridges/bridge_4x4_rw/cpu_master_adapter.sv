...
#(
    ...
    output axi4_aw_t     cpu_master_128b_aw,
    output logic         cpu_master_128b_awvalid,
    input  logic         cpu_master_128b_awready,

    output axi4_w_128b_t  cpu_master_128b_w,
    output logic         cpu_master_128b_wvalid,
    input  logic         cpu_master_128b_wready,

    input  axi4_b_t      cpu_master_128b_b,
    input  logic         cpu_master_128b_bvalid,
    output logic         cpu_master_128b_bready,

    output axi4_ar_t     cpu_master_128b_ar,
    output logic         cpu_master_128b_arvalid,
    input  logic         cpu_master_128b_arready,

    input  axi4_r_128b_t  cpu_master_128b_r,
    input  logic         cpu_master_128b_rvalid,
    output logic         cpu_master_128b_rready,
    ...
    assign aw_path_active_256b = (comb_slave_select_aw[3]) && aw_gate_ok;
    logic w_path_active_256b;
    assign w_path_active_256b = w_slave_select[3];
    logic ar_path_active_256b;
    assign ar_path_active_256b = (comb_slave_select_ar[3]) && ar_gate_ok;
    logic b_path_active_256b;
    assign b_path_active_256b = b_slave_select[3];
    logic r_path_active_256b;
    assign r_path_active_256b = r_slave_select[3];
    ...
    assign cpu_master_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    ...
    assign cpu_master_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign cpu_master_64b_bready = fub_axi_bready && b_path_active_64b;
    ...
    assign cpu_master_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign cpu_master_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(cpu_master_128b_aw.id),
        .m_axi_awaddr(cpu_master_128b_aw.addr),
        .m_axi_awlen(cpu_master_128b_aw.len),
        .m_axi_awsize(cpu_master_128b_aw.size),
        .m_axi_awburst(cpu_master_128b_aw.burst),
        .m_axi_awlock(cpu_master_128b_aw.lock),
        .m_axi_awcache(cpu_master_128b_aw.cache),
        .m_axi_awprot(cpu_master_128b_aw.prot),
        .m_axi_awqos(cpu_master_128b_aw.qos),
        .m_axi_awregion(cpu_master_128b_aw.region),
        .m_axi_awuser(cpu_master_128b_aw.user),
        .m_axi_awvalid(cpu_master_128b_awvalid),
        .m_axi_awready(cpu_master_128b_awready),
        .m_axi_wdata(cpu_master_128b_w.data),
        .m_axi_wstrb(cpu_master_128b_w.strb),
        .m_axi_wlast(cpu_master_128b_w.last),
        .m_axi_wuser(cpu_master_128b_w.user),
        .m_axi_wvalid(cpu_master_128b_wvalid),
        .m_axi_wready(cpu_master_128b_wready),
        .m_axi_bid(cpu_master_128b_b.id),
        .m_axi_bresp(cpu_master_128b_b.resp),
        .m_axi_buser(cpu_master_128b_b.user),
        .m_axi_bvalid(cpu_master_128b_bvalid),
        .m_axi_bready(cpu_master_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(cpu_master_128b_ar.id),
        .m_axi_araddr(cpu_master_128b_ar.addr),
        .m_axi_arlen(cpu_master_128b_ar.len),
        .m_axi_arsize(cpu_master_128b_ar.size),
        .m_axi_arburst(cpu_master_128b_ar.burst),
        .m_axi_arlock(cpu_master_128b_ar.lock),
        .m_axi_arcache(cpu_master_128b_ar.cache),
        .m_axi_arprot(cpu_master_128b_ar.prot),
        .m_axi_arqos(cpu_master_128b_ar.qos),
        .m_axi_arregion(cpu_master_128b_ar.region),
        .m_axi_aruser(cpu_master_128b_ar.user),
        .m_axi_arvalid(cpu_master_128b_arvalid),
        .m_axi_arready(cpu_master_128b_arready),
        .m_axi_rid(cpu_master_128b_r.id),
        .m_axi_rdata(cpu_master_128b_r.data),
        .m_axi_rresp(cpu_master_128b_r.resp),
        .m_axi_rlast(cpu_master_128b_r.last),
        .m_axi_ruser(cpu_master_128b_r.user),
        .m_axi_rvalid(cpu_master_128b_rvalid),
        .m_axi_rready(cpu_master_128b_rready)
    );
