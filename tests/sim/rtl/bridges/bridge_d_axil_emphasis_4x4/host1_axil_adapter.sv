// HOST1_AXIL Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for host1_axil master
...
#(
    ...
    // External AXI interface (from host1_axil master)
    input  logic         host1_axil_awid,
    input  logic [31:0]  host1_axil_awaddr,
    input  logic [7:0]  host1_axil_awlen,
    input  logic [2:0]  host1_axil_awsize,
    input  logic [1:0]  host1_axil_awburst,
    input  logic         host1_axil_awlock,
    input  logic [3:0]  host1_axil_awcache,
    input  logic [2:0]  host1_axil_awprot,
    input  logic [3:0]  host1_axil_awqos,
    input  logic [3:0]  host1_axil_awregion,
    input  logic         host1_axil_awuser,
    ...
    input  logic         host1_axil_wlast,
    input  logic         host1_axil_wuser,
    input  logic         host1_axil_wvalid,
    output  logic         host1_axil_wready,

    output  logic         host1_axil_bid,
    output  logic [1:0]  host1_axil_bresp,
    output  logic         host1_axil_buser,
    output  logic         host1_axil_bvalid,
    input  logic         host1_axil_bready,

    input  logic         host1_axil_arid,
    input  logic [31:0]  host1_axil_araddr,
    input  logic [7:0]  host1_axil_arlen,
    input  logic [2:0]  host1_axil_arsize,
    input  logic [1:0]  host1_axil_arburst,
    input  logic         host1_axil_arlock,
    input  logic [3:0]  host1_axil_arcache,
    input  logic [2:0]  host1_axil_arprot,
    input  logic [3:0]  host1_axil_arqos,
    input  logic [3:0]  host1_axil_arregion,
    input  logic         host1_axil_aruser,
    input  logic         host1_axil_arvalid,
    output  logic         host1_axil_arready,

    output  logic         host1_axil_rid,
    output  logic [31:0]  host1_axil_rdata,
    output  logic [1:0]  host1_axil_rresp,
    output  logic         host1_axil_rlast,
    output  logic         host1_axil_ruser,
    ...
    output axi4_aw_t     host1_axil_32b_aw,
    output logic         host1_axil_32b_awvalid,
    input  logic         host1_axil_32b_awready,

    output axi4_w_32b_t  host1_axil_32b_w,
    output logic         host1_axil_32b_wvalid,
    input  logic         host1_axil_32b_wready,

    input  axi4_b_t      host1_axil_32b_b,
    input  logic         host1_axil_32b_bvalid,
    output logic         host1_axil_32b_bready,

    output axi4_ar_t     host1_axil_32b_ar,
    output logic         host1_axil_32b_arvalid,
    input  logic         host1_axil_32b_arready,

    input  axi4_r_32b_t  host1_axil_32b_r,
    input  logic         host1_axil_32b_rvalid,
    output logic         host1_axil_32b_rready,

    output axi4_aw_t     host1_axil_128b_aw,
    output logic         host1_axil_128b_awvalid,
    input  logic         host1_axil_128b_awready,

    output axi4_w_128b_t  host1_axil_128b_w,
    output logic         host1_axil_128b_wvalid,
    input  logic         host1_axil_128b_wready,

    input  axi4_b_t      host1_axil_128b_b,
    input  logic         host1_axil_128b_bvalid,
    output logic         host1_axil_128b_bready,

    output axi4_ar_t     host1_axil_128b_ar,
    output logic         host1_axil_128b_arvalid,
    input  logic         host1_axil_128b_arready,

    input  axi4_r_128b_t  host1_axil_128b_r,
    input  logic         host1_axil_128b_rvalid,
    output logic         host1_axil_128b_rready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(host1_axil_awid),
        .s_axi_awaddr(host1_axil_awaddr),
        .s_axi_awlen(host1_axil_awlen),
        .s_axi_awsize(host1_axil_awsize),
        .s_axi_awburst(host1_axil_awburst),
        .s_axi_awlock(host1_axil_awlock),
        .s_axi_awcache(host1_axil_awcache),
        .s_axi_awprot(host1_axil_awprot),
        .s_axi_awqos(host1_axil_awqos),
        .s_axi_awregion(host1_axil_awregion),
        .s_axi_awuser(host1_axil_awuser),
        .s_axi_awvalid(host1_axil_awvalid),
        .s_axi_awready(host1_axil_awready),
        .s_axi_wdata(host1_axil_wdata),
        .s_axi_wstrb(host1_axil_wstrb),
        .s_axi_wlast(host1_axil_wlast),
        .s_axi_wuser(host1_axil_wuser),
        .s_axi_wvalid(host1_axil_wvalid),
        .s_axi_wready(host1_axil_wready),
        .s_axi_bid(host1_axil_bid),
        .s_axi_bresp(host1_axil_bresp),
        .s_axi_buser(host1_axil_buser),
        .s_axi_bvalid(host1_axil_bvalid),
        .s_axi_bready(host1_axil_bready),
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(host1_axil_arid),
        .s_axi_araddr(host1_axil_araddr),
        .s_axi_arlen(host1_axil_arlen),
        .s_axi_arsize(host1_axil_arsize),
        .s_axi_arburst(host1_axil_arburst),
        .s_axi_arlock(host1_axil_arlock),
        .s_axi_arcache(host1_axil_arcache),
        .s_axi_arprot(host1_axil_arprot),
        .s_axi_arqos(host1_axil_arqos),
        .s_axi_arregion(host1_axil_arregion),
        .s_axi_aruser(host1_axil_aruser),
        .s_axi_arvalid(host1_axil_arvalid),
        .s_axi_arready(host1_axil_arready),
        .s_axi_rid(host1_axil_rid),
        .s_axi_rdata(host1_axil_rdata),
        .s_axi_rresp(host1_axil_rresp),
        .s_axi_rlast(host1_axil_rlast),
        .s_axi_ruser(host1_axil_ruser),
        .s_axi_rvalid(host1_axil_rvalid),
        .s_axi_rready(host1_axil_rready),
    ...
    // Requests: fub_axi_* → host1_axil_32b_*
    // Responses: host1_axil_32b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign host1_axil_32b_aw.id     = fub_axi_awid;
    assign host1_axil_32b_aw.addr   = fub_axi_awaddr;
    assign host1_axil_32b_aw.len    = fub_axi_awlen;
    assign host1_axil_32b_aw.size   = fub_axi_awsize;
    assign host1_axil_32b_aw.burst  = fub_axi_awburst;
    assign host1_axil_32b_aw.lock   = fub_axi_awlock;
    assign host1_axil_32b_aw.cache  = fub_axi_awcache;
    assign host1_axil_32b_aw.prot   = fub_axi_awprot;
    assign host1_axil_32b_aw.qos    = 4'b0;  // Tie to 0
    assign host1_axil_32b_aw.region = 4'b0;  // Tie to 0
    assign host1_axil_32b_aw.user   = 1'b0;  // Tie to 0
    assign host1_axil_32b_awvalid   = fub_axi_awvalid && aw_path_active_32b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign host1_axil_32b_w.data  = fub_axi_wdata;
    assign host1_axil_32b_w.strb  = fub_axi_wstrb;
    assign host1_axil_32b_w.last  = fub_axi_wlast;
    assign host1_axil_32b_w.user  = 1'b0;  // Tie to 0
    assign host1_axil_32b_wvalid  = fub_axi_wvalid && w_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign host1_axil_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign host1_axil_32b_ar.id     = fub_axi_arid;
    assign host1_axil_32b_ar.addr   = fub_axi_araddr;
    assign host1_axil_32b_ar.len    = fub_axi_arlen;
    assign host1_axil_32b_ar.size   = fub_axi_arsize;
    assign host1_axil_32b_ar.burst  = fub_axi_arburst;
    assign host1_axil_32b_ar.lock   = fub_axi_arlock;
    assign host1_axil_32b_ar.cache  = fub_axi_arcache;
    assign host1_axil_32b_ar.prot   = fub_axi_arprot;
    assign host1_axil_32b_ar.qos    = 4'b0;  // Tie to 0
    assign host1_axil_32b_ar.region = 4'b0;  // Tie to 0
    assign host1_axil_32b_ar.user   = 1'b0;  // Tie to 0
    assign host1_axil_32b_arvalid   = fub_axi_arvalid && ar_path_active_32b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign host1_axil_32b_rready = fub_axi_rready && r_path_active_32b;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(host1_axil_128b_aw.id),
        .m_axi_awaddr(host1_axil_128b_aw.addr),
        .m_axi_awlen(host1_axil_128b_aw.len),
        .m_axi_awsize(host1_axil_128b_aw.size),
        .m_axi_awburst(host1_axil_128b_aw.burst),
        .m_axi_awlock(host1_axil_128b_aw.lock),
        .m_axi_awcache(host1_axil_128b_aw.cache),
        .m_axi_awprot(host1_axil_128b_aw.prot),
        .m_axi_awqos(host1_axil_128b_aw.qos),
        .m_axi_awregion(host1_axil_128b_aw.region),
        .m_axi_awuser(host1_axil_128b_aw.user),
        .m_axi_awvalid(host1_axil_128b_awvalid),
        .m_axi_awready(host1_axil_128b_awready),
        .m_axi_wdata(host1_axil_128b_w.data),
        .m_axi_wstrb(host1_axil_128b_w.strb),
        .m_axi_wlast(host1_axil_128b_w.last),
        .m_axi_wuser(host1_axil_128b_w.user),
        .m_axi_wvalid(host1_axil_128b_wvalid),
        .m_axi_wready(host1_axil_128b_wready),
        .m_axi_bid(host1_axil_128b_b.id),
        .m_axi_bresp(host1_axil_128b_b.resp),
        .m_axi_buser(host1_axil_128b_b.user),
        .m_axi_bvalid(host1_axil_128b_bvalid),
        .m_axi_bready(host1_axil_128b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(host1_axil_128b_ar.id),
        .m_axi_araddr(host1_axil_128b_ar.addr),
        .m_axi_arlen(host1_axil_128b_ar.len),
        .m_axi_arsize(host1_axil_128b_ar.size),
        .m_axi_arburst(host1_axil_128b_ar.burst),
        .m_axi_arlock(host1_axil_128b_ar.lock),
        .m_axi_arcache(host1_axil_128b_ar.cache),
        .m_axi_arprot(host1_axil_128b_ar.prot),
        .m_axi_arqos(host1_axil_128b_ar.qos),
        .m_axi_arregion(host1_axil_128b_ar.region),
        .m_axi_aruser(host1_axil_128b_ar.user),
        .m_axi_arvalid(host1_axil_128b_arvalid),
        .m_axi_arready(host1_axil_128b_arready),
        .m_axi_rid(host1_axil_128b_r.id),
        .m_axi_rdata(host1_axil_128b_r.data),
        .m_axi_rresp(host1_axil_128b_r.resp),
        .m_axi_rlast(host1_axil_128b_r.last),
        .m_axi_ruser(host1_axil_128b_r.user),
        .m_axi_rvalid(host1_axil_128b_rvalid),
        .m_axi_rready(host1_axil_128b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_awready = host1_axil_32b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_wready = host1_axil_32b_wready;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_wready = host1_axil_32b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_bid = host1_axil_32b_b.id;
                fub_axi_bresp = host1_axil_32b_b.resp;
                fub_axi_bvalid = host1_axil_32b_bvalid;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_bid = host1_axil_32b_b.id;
                fub_axi_bresp = host1_axil_32b_b.resp;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_arready = host1_axil_32b_arready;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_arready = host1_axil_32b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_rid = host1_axil_32b_r.id;
                fub_axi_rdata = host1_axil_32b_r.data;
                fub_axi_rresp = host1_axil_32b_r.resp;
                fub_axi_rlast = host1_axil_32b_r.last;
                fub_axi_rvalid = host1_axil_32b_rvalid;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_rid = host1_axil_32b_r.id;
                fub_axi_rdata = host1_axil_32b_r.data;
