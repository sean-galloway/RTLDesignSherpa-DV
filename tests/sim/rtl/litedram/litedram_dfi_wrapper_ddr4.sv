...
module litedram_dfi_wrapper_ddr4 (
    // ----- Clock + reset + status -----
    ...
    // Phase 0
    output wire [14:0] dfi_p0_address,
    ...
    output wire [127:0] dfi_p0_wrdata,
    output wire          dfi_p0_wrdata_en,
    output wire [15:0] dfi_p0_wrdata_mask,
    output wire [127:0] dfi_p0_rddata,
    output wire          dfi_p0_rddata_en,
    output wire          dfi_p0_rddata_valid,
    // Phase 1
    output wire [14:0] dfi_p1_address,
    ...
    output wire [127:0] dfi_p1_wrdata,
    output wire          dfi_p1_wrdata_en,
    output wire [15:0] dfi_p1_wrdata_mask,
    output wire [127:0] dfi_p1_rddata,
    output wire          dfi_p1_rddata_en,
    output wire          dfi_p1_rddata_valid,
    // Phase 2
    output wire [14:0] dfi_p2_address,
    ...
    output wire [127:0] dfi_p2_wrdata,
    output wire          dfi_p2_wrdata_en,
    output wire [15:0] dfi_p2_wrdata_mask,
    output wire [127:0] dfi_p2_rddata,
    output wire          dfi_p2_rddata_en,
    output wire          dfi_p2_rddata_valid,
    // Phase 3
    output wire [14:0] dfi_p3_address,
    ...
    output wire [127:0] dfi_p3_wrdata,
    output wire          dfi_p3_wrdata_en,
    output wire [15:0] dfi_p3_wrdata_mask,
    output wire [127:0] dfi_p3_rddata,
