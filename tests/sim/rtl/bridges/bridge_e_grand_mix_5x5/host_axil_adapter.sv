...
#(
    ...
    output axi4_aw_t     host_axil_128b_aw,
    output logic         host_axil_128b_awvalid,
    input  logic         host_axil_128b_awready,

    output axi4_w_128b_t  host_axil_128b_w,
    output logic         host_axil_128b_wvalid,
    input  logic         host_axil_128b_wready,

    input  axi4_b_t      host_axil_128b_b,
    input  logic         host_axil_128b_bvalid,
    output logic         host_axil_128b_bready,

    output axi4_ar_t     host_axil_128b_ar,
    output logic         host_axil_128b_arvalid,
    input  logic         host_axil_128b_arready,

    input  axi4_r_128b_t  host_axil_128b_r,
    input  logic         host_axil_128b_rvalid,
    output logic         host_axil_128b_rready,

    output axi4_aw_t     host_axil_256b_aw,
    output logic         host_axil_256b_awvalid,
    input  logic         host_axil_256b_awready,

    output axi4_w_256b_t  host_axil_256b_w,
    output logic         host_axil_256b_wvalid,
    input  logic         host_axil_256b_wready,

    input  axi4_b_t      host_axil_256b_b,
    input  logic         host_axil_256b_bvalid,
    output logic         host_axil_256b_bready,

    output axi4_ar_t     host_axil_256b_ar,
    output logic         host_axil_256b_arvalid,
    input  logic         host_axil_256b_arready,

    input  axi4_r_256b_t  host_axil_256b_r,
    input  logic         host_axil_256b_rvalid,
    output logic         host_axil_256b_rready
);
    ...
    assign host_axil_32b_bready = fub_axi_bready && b_path_active_32b;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(host_axil_128b_aw.id),
        .m_axi_awaddr(host_axil_128b_aw.addr),
        .m_axi_awlen(host_axil_128b_aw.len),
        .m_axi_awsize(host_axil_128b_aw.size),
        .m_axi_awburst(host_axil_128b_aw.burst),
        .m_axi_awlock(host_axil_128b_aw.lock),
        .m_axi_awcache(host_axil_128b_aw.cache),
        .m_axi_awprot(host_axil_128b_aw.prot),
        .m_axi_awqos(host_axil_128b_aw.qos),
        .m_axi_awregion(host_axil_128b_aw.region),
        .m_axi_awuser(host_axil_128b_aw.user),
        .m_axi_awvalid(host_axil_128b_awvalid),
        .m_axi_awready(host_axil_128b_awready),
        .m_axi_wdata(host_axil_128b_w.data),
        .m_axi_wstrb(host_axil_128b_w.strb),
        .m_axi_wlast(host_axil_128b_w.last),
        .m_axi_wuser(host_axil_128b_w.user),
        .m_axi_wvalid(host_axil_128b_wvalid),
        .m_axi_wready(host_axil_128b_wready),
        .m_axi_bid(host_axil_128b_b.id),
        .m_axi_bresp(host_axil_128b_b.resp),
        .m_axi_buser(host_axil_128b_b.user),
        .m_axi_bvalid(host_axil_128b_bvalid),
        .m_axi_bready(host_axil_128b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(host_axil_128b_ar.id),
        .m_axi_araddr(host_axil_128b_ar.addr),
        .m_axi_arlen(host_axil_128b_ar.len),
        .m_axi_arsize(host_axil_128b_ar.size),
        .m_axi_arburst(host_axil_128b_ar.burst),
        .m_axi_arlock(host_axil_128b_ar.lock),
        .m_axi_arcache(host_axil_128b_ar.cache),
        .m_axi_arprot(host_axil_128b_ar.prot),
        .m_axi_arqos(host_axil_128b_ar.qos),
        .m_axi_arregion(host_axil_128b_ar.region),
        .m_axi_aruser(host_axil_128b_ar.user),
        .m_axi_arvalid(host_axil_128b_arvalid),
        .m_axi_arready(host_axil_128b_arready),
        .m_axi_rid(host_axil_128b_r.id),
        .m_axi_rdata(host_axil_128b_r.data),
        .m_axi_rresp(host_axil_128b_r.resp),
        .m_axi_rlast(host_axil_128b_r.last),
        .m_axi_ruser(host_axil_128b_r.user),
        .m_axi_rvalid(host_axil_128b_rvalid),
        .m_axi_rready(host_axil_128b_rready)
    );
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(host_axil_256b_aw.id),
        .m_axi_awaddr(host_axil_256b_aw.addr),
        .m_axi_awlen(host_axil_256b_aw.len),
        .m_axi_awsize(host_axil_256b_aw.size),
        .m_axi_awburst(host_axil_256b_aw.burst),
        .m_axi_awlock(host_axil_256b_aw.lock),
        .m_axi_awcache(host_axil_256b_aw.cache),
        .m_axi_awprot(host_axil_256b_aw.prot),
        .m_axi_awqos(host_axil_256b_aw.qos),
        .m_axi_awregion(host_axil_256b_aw.region),
        .m_axi_awuser(host_axil_256b_aw.user),
        .m_axi_awvalid(host_axil_256b_awvalid),
        .m_axi_awready(host_axil_256b_awready),
        .m_axi_wdata(host_axil_256b_w.data),
        .m_axi_wstrb(host_axil_256b_w.strb),
        .m_axi_wlast(host_axil_256b_w.last),
        .m_axi_wuser(host_axil_256b_w.user),
        .m_axi_wvalid(host_axil_256b_wvalid),
        .m_axi_wready(host_axil_256b_wready),
        .m_axi_bid(host_axil_256b_b.id),
        .m_axi_bresp(host_axil_256b_b.resp),
        .m_axi_buser(host_axil_256b_b.user),
        .m_axi_bvalid(host_axil_256b_bvalid),
        .m_axi_bready(host_axil_256b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(host_axil_256b_ar.id),
        .m_axi_araddr(host_axil_256b_ar.addr),
        .m_axi_arlen(host_axil_256b_ar.len),
        .m_axi_arsize(host_axil_256b_ar.size),
        .m_axi_arburst(host_axil_256b_ar.burst),
        .m_axi_arlock(host_axil_256b_ar.lock),
        .m_axi_arcache(host_axil_256b_ar.cache),
        .m_axi_arprot(host_axil_256b_ar.prot),
        .m_axi_arqos(host_axil_256b_ar.qos),
        .m_axi_arregion(host_axil_256b_ar.region),
        .m_axi_aruser(host_axil_256b_ar.user),
        .m_axi_arvalid(host_axil_256b_arvalid),
        .m_axi_arready(host_axil_256b_arready),
        .m_axi_rid(host_axil_256b_r.id),
        .m_axi_rdata(host_axil_256b_r.data),
        .m_axi_rresp(host_axil_256b_r.resp),
        .m_axi_rlast(host_axil_256b_r.last),
        .m_axi_ruser(host_axil_256b_r.user),
        .m_axi_rvalid(host_axil_256b_rvalid),
        .m_axi_rready(host_axil_256b_rready)
    );
