...
module cpu_adapter #(
    ...
    assign aw_path_active_32b = comb_slave_select_aw[3] | comb_slave_select_aw[4] | comb_slave_select_aw[5];
    ...
    assign ar_path_active_32b = comb_slave_select_ar[3] | comb_slave_select_ar[4] | comb_slave_select_ar[5];
