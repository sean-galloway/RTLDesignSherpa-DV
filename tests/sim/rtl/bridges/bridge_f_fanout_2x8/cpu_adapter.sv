...
#(
    ...
    assign aw_path_active_32b = comb_slave_select_aw[4] | comb_slave_select_aw[5] | comb_slave_select_aw[6] | comb_slave_select_aw[7];
    ...
    assign ar_path_active_32b = comb_slave_select_ar[4] | comb_slave_select_ar[5] | comb_slave_select_ar[6] | comb_slave_select_ar[7];
    logic aw_path_active_64b;
    assign aw_path_active_64b = comb_slave_select_aw[2] | comb_slave_select_aw[3];
    logic w_path_active_64b;
    assign w_path_active_64b = w_slave_select[2] | w_slave_select[3];
    logic ar_path_active_64b;
    assign ar_path_active_64b = comb_slave_select_ar[2] | comb_slave_select_ar[3];
    ...
    assign cpu_64b_bready = fub_axi_bready;
    ...
    assign cpu_64b_rready = fub_axi_rready;
