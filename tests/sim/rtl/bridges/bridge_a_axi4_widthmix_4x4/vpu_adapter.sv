// VPU Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for vpu master
...
#(
    ...
    // External AXI interface (from vpu master)
    ...
    output axi4_aw_t     vpu_128b_aw,
    output logic         vpu_128b_awvalid,
    input  logic         vpu_128b_awready,

    output axi4_w_128b_t  vpu_128b_w,
    output logic         vpu_128b_wvalid,
    input  logic         vpu_128b_wready,

    input  axi4_b_t      vpu_128b_b,
    input  logic         vpu_128b_bvalid,
    output logic         vpu_128b_bready,

    output axi4_ar_t     vpu_128b_ar,
    output logic         vpu_128b_arvalid,
    input  logic         vpu_128b_arready,

    input  axi4_r_128b_t  vpu_128b_r,
    input  logic         vpu_128b_rvalid,
    output logic         vpu_128b_rready,

    output axi4_aw_t     vpu_256b_aw,
    output logic         vpu_256b_awvalid,
    input  logic         vpu_256b_awready,

    output axi4_w_256b_t  vpu_256b_w,
    output logic         vpu_256b_wvalid,
    input  logic         vpu_256b_wready,

    input  axi4_b_t      vpu_256b_b,
    input  logic         vpu_256b_bvalid,
    output logic         vpu_256b_bready,

    output axi4_ar_t     vpu_256b_ar,
    output logic         vpu_256b_arvalid,
    input  logic         vpu_256b_arready,

    input  axi4_r_256b_t  vpu_256b_r,
    input  logic         vpu_256b_rvalid,
    output logic         vpu_256b_rready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(vpu_axi_awid),
        .s_axi_awaddr(vpu_axi_awaddr),
        .s_axi_awlen(vpu_axi_awlen),
        .s_axi_awsize(vpu_axi_awsize),
        .s_axi_awburst(vpu_axi_awburst),
        .s_axi_awlock(vpu_axi_awlock),
        .s_axi_awcache(vpu_axi_awcache),
        .s_axi_awprot(vpu_axi_awprot),
        .s_axi_awqos(vpu_axi_awqos),
        .s_axi_awregion(vpu_axi_awregion),
        .s_axi_awuser(vpu_axi_awuser),
        .s_axi_awvalid(vpu_axi_awvalid),
        .s_axi_awready(vpu_axi_awready),
        .s_axi_wdata(vpu_axi_wdata),
        .s_axi_wstrb(vpu_axi_wstrb),
        .s_axi_wlast(vpu_axi_wlast),
        .s_axi_wuser(vpu_axi_wuser),
        .s_axi_wvalid(vpu_axi_wvalid),
        .s_axi_wready(vpu_axi_wready),
        .s_axi_bid(vpu_axi_bid),
        .s_axi_bresp(vpu_axi_bresp),
        .s_axi_buser(vpu_axi_buser),
        .s_axi_bvalid(vpu_axi_bvalid),
        .s_axi_bready(vpu_axi_bready),
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(vpu_axi_arid),
        .s_axi_araddr(vpu_axi_araddr),
        .s_axi_arlen(vpu_axi_arlen),
        .s_axi_arsize(vpu_axi_arsize),
        .s_axi_arburst(vpu_axi_arburst),
        .s_axi_arlock(vpu_axi_arlock),
        .s_axi_arcache(vpu_axi_arcache),
        .s_axi_arprot(vpu_axi_arprot),
        .s_axi_arqos(vpu_axi_arqos),
        .s_axi_arregion(vpu_axi_arregion),
        .s_axi_aruser(vpu_axi_aruser),
        .s_axi_arvalid(vpu_axi_arvalid),
        .s_axi_arready(vpu_axi_arready),
        .s_axi_rid(vpu_axi_rid),
        .s_axi_rdata(vpu_axi_rdata),
        .s_axi_rresp(vpu_axi_rresp),
        .s_axi_rlast(vpu_axi_rlast),
        .s_axi_ruser(vpu_axi_ruser),
        .s_axi_rvalid(vpu_axi_rvalid),
        .s_axi_rready(vpu_axi_rready),
    ...
    // Connected to slaves with widths: [128, 256]
    // ================================================================
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awid(vpu_128b_aw.id),
        .m_axi_awaddr(vpu_128b_aw.addr),
        .m_axi_awlen(vpu_128b_aw.len),
        .m_axi_awsize(vpu_128b_aw.size),
        .m_axi_awburst(vpu_128b_aw.burst),
        .m_axi_awlock(vpu_128b_aw.lock),
        .m_axi_awcache(vpu_128b_aw.cache),
        .m_axi_awprot(vpu_128b_aw.prot),
        .m_axi_awqos(vpu_128b_aw.qos),
        .m_axi_awregion(vpu_128b_aw.region),
        .m_axi_awuser(vpu_128b_aw.user),
        .m_axi_awvalid(vpu_128b_awvalid),
        .m_axi_awready(vpu_128b_awready),
        .m_axi_wdata(vpu_128b_w.data),
        .m_axi_wstrb(vpu_128b_w.strb),
        .m_axi_wlast(vpu_128b_w.last),
        .m_axi_wuser(vpu_128b_w.user),
        .m_axi_wvalid(vpu_128b_wvalid),
        .m_axi_wready(vpu_128b_wready),
        .m_axi_bid(vpu_128b_b.id),
        .m_axi_bresp(vpu_128b_b.resp),
        .m_axi_buser(vpu_128b_b.user),
        .m_axi_bvalid(vpu_128b_bvalid),
        .m_axi_bready(vpu_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(vpu_128b_ar.id),
        .m_axi_araddr(vpu_128b_ar.addr),
        .m_axi_arlen(vpu_128b_ar.len),
        .m_axi_arsize(vpu_128b_ar.size),
        .m_axi_arburst(vpu_128b_ar.burst),
        .m_axi_arlock(vpu_128b_ar.lock),
        .m_axi_arcache(vpu_128b_ar.cache),
        .m_axi_arprot(vpu_128b_ar.prot),
        .m_axi_arqos(vpu_128b_ar.qos),
        .m_axi_arregion(vpu_128b_ar.region),
        .m_axi_aruser(vpu_128b_ar.user),
        .m_axi_arvalid(vpu_128b_arvalid),
        .m_axi_arready(vpu_128b_arready),
        .m_axi_rid(vpu_128b_r.id),
        .m_axi_rdata(vpu_128b_r.data),
        .m_axi_rresp(vpu_128b_r.resp),
        .m_axi_rlast(vpu_128b_r.last),
        .m_axi_ruser(vpu_128b_r.user),
        .m_axi_rvalid(vpu_128b_rvalid),
        .m_axi_rready(vpu_128b_rready)
    );

    // ================================================================
    // Direct passthrough: 256b → 256b (no converter)
    // Requests: fub_axi_* → vpu_256b_*
    // Responses: vpu_256b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign vpu_256b_aw.id     = fub_axi_awid;
    assign vpu_256b_aw.addr   = fub_axi_awaddr;
    assign vpu_256b_aw.len    = fub_axi_awlen;
    assign vpu_256b_aw.size   = fub_axi_awsize;
    assign vpu_256b_aw.burst  = fub_axi_awburst;
    assign vpu_256b_aw.lock   = fub_axi_awlock;
    assign vpu_256b_aw.cache  = fub_axi_awcache;
    assign vpu_256b_aw.prot   = fub_axi_awprot;
    assign vpu_256b_aw.qos    = 4'b0;  // Tie to 0
    assign vpu_256b_aw.region = 4'b0;  // Tie to 0
    assign vpu_256b_aw.user   = 1'b0;  // Tie to 0
    assign vpu_256b_awvalid   = fub_axi_awvalid && aw_path_active_256b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign vpu_256b_w.data  = fub_axi_wdata;
    assign vpu_256b_w.strb  = fub_axi_wstrb;
    assign vpu_256b_w.last  = fub_axi_wlast;
    assign vpu_256b_w.user  = 1'b0;  // Tie to 0
    assign vpu_256b_wvalid  = fub_axi_wvalid && w_path_active_256b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign vpu_256b_bready = fub_axi_bready && b_path_active_256b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign vpu_256b_ar.id     = fub_axi_arid;
    assign vpu_256b_ar.addr   = fub_axi_araddr;
    assign vpu_256b_ar.len    = fub_axi_arlen;
    assign vpu_256b_ar.size   = fub_axi_arsize;
    assign vpu_256b_ar.burst  = fub_axi_arburst;
    assign vpu_256b_ar.lock   = fub_axi_arlock;
    assign vpu_256b_ar.cache  = fub_axi_arcache;
    assign vpu_256b_ar.prot   = fub_axi_arprot;
    assign vpu_256b_ar.qos    = 4'b0;  // Tie to 0
    assign vpu_256b_ar.region = 4'b0;  // Tie to 0
    assign vpu_256b_ar.user   = 1'b0;  // Tie to 0
    assign vpu_256b_arvalid   = fub_axi_arvalid && ar_path_active_256b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign vpu_256b_rready = fub_axi_rready && r_path_active_256b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            ...
            4'b0001: begin  // Slave 0 (256b)
                fub_axi_awready = vpu_256b_awready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            ...
            4'b0001: begin  // Slave 0 (256b)
                fub_axi_wready = vpu_256b_wready;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            4'b0001: begin  // Slave 0 (256b)
                fub_axi_bid = vpu_256b_b.id;
                fub_axi_bresp = vpu_256b_b.resp;
                fub_axi_bvalid = vpu_256b_bvalid;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            4'b0001: begin  // Slave 0 (256b)
                fub_axi_arready = vpu_256b_arready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            4'b0001: begin  // Slave 0 (256b)
                fub_axi_rid = vpu_256b_r.id;
                fub_axi_rdata = vpu_256b_r.data;
                fub_axi_rresp = vpu_256b_r.resp;
                fub_axi_rlast = vpu_256b_r.last;
                fub_axi_rvalid = vpu_256b_rvalid;
            end
            default: begin
                // No slave selected - hold defaults
            end
