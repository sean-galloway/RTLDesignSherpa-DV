...
The Wishbone B4 (pipelined) family: a master, a slave over a memory model, a monitor with the protocol checks, a packet class, and the factories that wire them up.
