...
>
> **Open work:** tracked in the vault — see
> [vault/Tasks/dfi/](vault/Tasks/dfi/INDEX.md). The DFI parity items
> (D1–D11) were migrated there 2026-08-13 as DFI-011…DFI-021.
...
**Migrated 2026-08-13 to [vault/Tasks/dfi/](vault/Tasks/dfi/INDEX.md).**
Items D1–D11 now live there as DFI-011…DFI-021, alongside the rest of the
DFI work (CA maps, state model, release cut) and the deferred items whose
blockers are named. Task tracking for this repo lives in the vault, not
beside the code — see [vault/Tasks/INDEX.md](vault/Tasks/INDEX.md).
