// GPU Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for gpu master
...
#(
    ...
    // External AXI interface (from gpu master)
    ...
    output axi4_aw_t     gpu_32b_aw,
    output logic         gpu_32b_awvalid,
    input  logic         gpu_32b_awready,

    output axi4_w_32b_t  gpu_32b_w,
    output logic         gpu_32b_wvalid,
    input  logic         gpu_32b_wready,

    input  axi4_b_t      gpu_32b_b,
    input  logic         gpu_32b_bvalid,
    output logic         gpu_32b_bready,

    output axi4_ar_t     gpu_32b_ar,
    output logic         gpu_32b_arvalid,
    input  logic         gpu_32b_arready,

    input  axi4_r_32b_t  gpu_32b_r,
    input  logic         gpu_32b_rvalid,
    output logic         gpu_32b_rready,

    output axi4_aw_t     gpu_128b_aw,
    output logic         gpu_128b_awvalid,
    input  logic         gpu_128b_awready,

    output axi4_w_128b_t  gpu_128b_w,
    output logic         gpu_128b_wvalid,
    input  logic         gpu_128b_wready,

    input  axi4_b_t      gpu_128b_b,
    input  logic         gpu_128b_bvalid,
    output logic         gpu_128b_bready,

    output axi4_ar_t     gpu_128b_ar,
    output logic         gpu_128b_arvalid,
    input  logic         gpu_128b_arready,

    input  axi4_r_128b_t  gpu_128b_r,
    input  logic         gpu_128b_rvalid,
    output logic         gpu_128b_rready,

    output axi4_aw_t     gpu_256b_aw,
    output logic         gpu_256b_awvalid,
    input  logic         gpu_256b_awready,

    output axi4_w_256b_t  gpu_256b_w,
    output logic         gpu_256b_wvalid,
    input  logic         gpu_256b_wready,

    input  axi4_b_t      gpu_256b_b,
    input  logic         gpu_256b_bvalid,
    output logic         gpu_256b_bready,

    output axi4_ar_t     gpu_256b_ar,
    output logic         gpu_256b_arvalid,
    input  logic         gpu_256b_arready,

    input  axi4_r_256b_t  gpu_256b_r,
    input  logic         gpu_256b_rvalid,
    output logic         gpu_256b_rready
);
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awid(gpu_32b_aw.id),
        .m_axi_awaddr(gpu_32b_aw.addr),
        .m_axi_awlen(gpu_32b_aw.len),
        .m_axi_awsize(gpu_32b_aw.size),
        .m_axi_awburst(gpu_32b_aw.burst),
        .m_axi_awlock(gpu_32b_aw.lock),
        .m_axi_awcache(gpu_32b_aw.cache),
        .m_axi_awprot(gpu_32b_aw.prot),
        .m_axi_awqos(gpu_32b_aw.qos),
        .m_axi_awregion(gpu_32b_aw.region),
        .m_axi_awuser(gpu_32b_aw.user),
        .m_axi_awvalid(gpu_32b_awvalid),
        .m_axi_awready(gpu_32b_awready),
        .m_axi_wdata(gpu_32b_w.data),
        .m_axi_wstrb(gpu_32b_w.strb),
        .m_axi_wlast(gpu_32b_w.last),
        .m_axi_wuser(gpu_32b_w.user),
        .m_axi_wvalid(gpu_32b_wvalid),
        .m_axi_wready(gpu_32b_wready),
        .m_axi_bid(gpu_32b_b.id),
        .m_axi_bresp(gpu_32b_b.resp),
        .m_axi_buser(gpu_32b_b.user),
        .m_axi_bvalid(gpu_32b_bvalid),
        .m_axi_bready(gpu_32b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(gpu_32b_ar.id),
        .m_axi_araddr(gpu_32b_ar.addr),
        .m_axi_arlen(gpu_32b_ar.len),
        .m_axi_arsize(gpu_32b_ar.size),
        .m_axi_arburst(gpu_32b_ar.burst),
        .m_axi_arlock(gpu_32b_ar.lock),
        .m_axi_arcache(gpu_32b_ar.cache),
        .m_axi_arprot(gpu_32b_ar.prot),
        .m_axi_arqos(gpu_32b_ar.qos),
        .m_axi_arregion(gpu_32b_ar.region),
        .m_axi_aruser(gpu_32b_ar.user),
        .m_axi_arvalid(gpu_32b_arvalid),
        .m_axi_arready(gpu_32b_arready),
        .m_axi_rid(gpu_32b_r.id),
        .m_axi_rdata(gpu_32b_r.data),
        .m_axi_rresp(gpu_32b_r.resp),
        .m_axi_rlast(gpu_32b_r.last),
        .m_axi_ruser(gpu_32b_r.user),
        .m_axi_rvalid(gpu_32b_rvalid),
        .m_axi_rready(gpu_32b_rready)
    );

    // ================================================================
    // Width converter: 256b → 128b
    // ================================================================
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(gpu_128b_aw.id),
        .m_axi_awaddr(gpu_128b_aw.addr),
        .m_axi_awlen(gpu_128b_aw.len),
        .m_axi_awsize(gpu_128b_aw.size),
        .m_axi_awburst(gpu_128b_aw.burst),
        .m_axi_awlock(gpu_128b_aw.lock),
        .m_axi_awcache(gpu_128b_aw.cache),
        .m_axi_awprot(gpu_128b_aw.prot),
        .m_axi_awqos(gpu_128b_aw.qos),
        .m_axi_awregion(gpu_128b_aw.region),
        .m_axi_awuser(gpu_128b_aw.user),
        .m_axi_awvalid(gpu_128b_awvalid),
        .m_axi_awready(gpu_128b_awready),
        .m_axi_wdata(gpu_128b_w.data),
        .m_axi_wstrb(gpu_128b_w.strb),
        .m_axi_wlast(gpu_128b_w.last),
        .m_axi_wuser(gpu_128b_w.user),
        .m_axi_wvalid(gpu_128b_wvalid),
        .m_axi_wready(gpu_128b_wready),
        .m_axi_bid(gpu_128b_b.id),
        .m_axi_bresp(gpu_128b_b.resp),
        .m_axi_buser(gpu_128b_b.user),
        .m_axi_bvalid(gpu_128b_bvalid),
        .m_axi_bready(gpu_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(gpu_128b_ar.id),
        .m_axi_araddr(gpu_128b_ar.addr),
        .m_axi_arlen(gpu_128b_ar.len),
        .m_axi_arsize(gpu_128b_ar.size),
        .m_axi_arburst(gpu_128b_ar.burst),
        .m_axi_arlock(gpu_128b_ar.lock),
        .m_axi_arcache(gpu_128b_ar.cache),
        .m_axi_arprot(gpu_128b_ar.prot),
        .m_axi_arqos(gpu_128b_ar.qos),
        .m_axi_arregion(gpu_128b_ar.region),
        .m_axi_aruser(gpu_128b_ar.user),
        .m_axi_arvalid(gpu_128b_arvalid),
        .m_axi_arready(gpu_128b_arready),
        .m_axi_rid(gpu_128b_r.id),
        .m_axi_rdata(gpu_128b_r.data),
        .m_axi_rresp(gpu_128b_r.resp),
        .m_axi_rlast(gpu_128b_r.last),
        .m_axi_ruser(gpu_128b_r.user),
        .m_axi_rvalid(gpu_128b_rvalid),
        .m_axi_rready(gpu_128b_rready)
    );

    // ================================================================
    // Direct passthrough: 256b → 256b (no converter)
    // Requests: fub_axi_* → gpu_256b_*
    // Responses: gpu_256b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign gpu_256b_aw.id     = fub_axi_awid;
    assign gpu_256b_aw.addr   = fub_axi_awaddr;
    assign gpu_256b_aw.len    = fub_axi_awlen;
    assign gpu_256b_aw.size   = fub_axi_awsize;
    assign gpu_256b_aw.burst  = fub_axi_awburst;
    assign gpu_256b_aw.lock   = fub_axi_awlock;
    assign gpu_256b_aw.cache  = fub_axi_awcache;
    assign gpu_256b_aw.prot   = fub_axi_awprot;
    assign gpu_256b_aw.qos    = 4'b0;  // Tie to 0
    assign gpu_256b_aw.region = 4'b0;  // Tie to 0
    assign gpu_256b_aw.user   = 1'b0;  // Tie to 0
    assign gpu_256b_awvalid   = fub_axi_awvalid && aw_path_active_256b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign gpu_256b_w.data  = fub_axi_wdata;
    assign gpu_256b_w.strb  = fub_axi_wstrb;
    assign gpu_256b_w.last  = fub_axi_wlast;
    assign gpu_256b_w.user  = 1'b0;  // Tie to 0
    assign gpu_256b_wvalid  = fub_axi_wvalid && w_path_active_256b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign gpu_256b_bready = fub_axi_bready && b_path_active_256b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign gpu_256b_ar.id     = fub_axi_arid;
    assign gpu_256b_ar.addr   = fub_axi_araddr;
    assign gpu_256b_ar.len    = fub_axi_arlen;
    assign gpu_256b_ar.size   = fub_axi_arsize;
    assign gpu_256b_ar.burst  = fub_axi_arburst;
    assign gpu_256b_ar.lock   = fub_axi_arlock;
    assign gpu_256b_ar.cache  = fub_axi_arcache;
    assign gpu_256b_ar.prot   = fub_axi_arprot;
    assign gpu_256b_ar.qos    = 4'b0;  // Tie to 0
    assign gpu_256b_ar.region = 4'b0;  // Tie to 0
    assign gpu_256b_ar.user   = 1'b0;  // Tie to 0
    assign gpu_256b_arvalid   = fub_axi_arvalid && ar_path_active_256b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign gpu_256b_rready = fub_axi_rready && r_path_active_256b;
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            ...
            5'b00001: begin  // Slave 0 (256b)
                fub_axi_awready = gpu_256b_awready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            ...
            5'b00001: begin  // Slave 0 (256b)
                fub_axi_wready = gpu_256b_wready;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            5'b00001: begin  // Slave 0 (256b)
                fub_axi_bid = gpu_256b_b.id;
                fub_axi_bresp = gpu_256b_b.resp;
                fub_axi_bvalid = gpu_256b_bvalid;
            end
            default: begin
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            5'b00001: begin  // Slave 0 (256b)
                fub_axi_arready = gpu_256b_arready;
            end
            default: begin
                // No slave selected
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            5'b00001: begin  // Slave 0 (256b)
                fub_axi_rid = gpu_256b_r.id;
                fub_axi_rdata = gpu_256b_r.data;
                fub_axi_rresp = gpu_256b_r.resp;
                fub_axi_rlast = gpu_256b_r.last;
                fub_axi_rvalid = gpu_256b_rvalid;
            end
            default: begin
                // No slave selected - hold defaults
            end
