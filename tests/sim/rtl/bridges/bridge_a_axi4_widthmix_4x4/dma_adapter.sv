...
#(
    ...
    // Requests: fub_axi_* → dma_64b_*
    // Responses: dma_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign dma_64b_aw.id     = fub_axi_awid;
    assign dma_64b_aw.addr   = fub_axi_awaddr;
    assign dma_64b_aw.len    = fub_axi_awlen;
    assign dma_64b_aw.size   = fub_axi_awsize;
    assign dma_64b_aw.burst  = fub_axi_awburst;
    assign dma_64b_aw.lock   = fub_axi_awlock;
    assign dma_64b_aw.cache  = fub_axi_awcache;
    assign dma_64b_aw.prot   = fub_axi_awprot;
    assign dma_64b_aw.qos    = 4'b0;  // Tie to 0
    assign dma_64b_aw.region = 4'b0;  // Tie to 0
    assign dma_64b_aw.user   = 1'b0;  // Tie to 0
    assign dma_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign dma_64b_w.data  = fub_axi_wdata;
    assign dma_64b_w.strb  = fub_axi_wstrb;
    assign dma_64b_w.last  = fub_axi_wlast;
    assign dma_64b_w.user  = 1'b0;  // Tie to 0
    assign dma_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign dma_64b_bready = fub_axi_bready && b_path_active_64b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign dma_64b_ar.id     = fub_axi_arid;
    assign dma_64b_ar.addr   = fub_axi_araddr;
    assign dma_64b_ar.len    = fub_axi_arlen;
    assign dma_64b_ar.size   = fub_axi_arsize;
    assign dma_64b_ar.burst  = fub_axi_arburst;
    assign dma_64b_ar.lock   = fub_axi_arlock;
    assign dma_64b_ar.cache  = fub_axi_arcache;
    assign dma_64b_ar.prot   = fub_axi_arprot;
    assign dma_64b_ar.qos    = 4'b0;  // Tie to 0
    assign dma_64b_ar.region = 4'b0;  // Tie to 0
    assign dma_64b_ar.user   = 1'b0;  // Tie to 0
    assign dma_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign dma_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(dma_128b_aw.id),
        .m_axi_awaddr(dma_128b_aw.addr),
        .m_axi_awlen(dma_128b_aw.len),
        .m_axi_awsize(dma_128b_aw.size),
        .m_axi_awburst(dma_128b_aw.burst),
        .m_axi_awlock(dma_128b_aw.lock),
        .m_axi_awcache(dma_128b_aw.cache),
        .m_axi_awprot(dma_128b_aw.prot),
        .m_axi_awqos(dma_128b_aw.qos),
        .m_axi_awregion(dma_128b_aw.region),
        .m_axi_awuser(dma_128b_aw.user),
        .m_axi_awvalid(dma_128b_awvalid),
        .m_axi_awready(dma_128b_awready),
        .m_axi_wdata(dma_128b_w.data),
        .m_axi_wstrb(dma_128b_w.strb),
        .m_axi_wlast(dma_128b_w.last),
        .m_axi_wuser(dma_128b_w.user),
        .m_axi_wvalid(dma_128b_wvalid),
        .m_axi_wready(dma_128b_wready),
        .m_axi_bid(dma_128b_b.id),
        .m_axi_bresp(dma_128b_b.resp),
        .m_axi_buser(dma_128b_b.user),
        .m_axi_bvalid(dma_128b_bvalid),
        .m_axi_bready(dma_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma_128b_ar.id),
        .m_axi_araddr(dma_128b_ar.addr),
        .m_axi_arlen(dma_128b_ar.len),
        .m_axi_arsize(dma_128b_ar.size),
        .m_axi_arburst(dma_128b_ar.burst),
        .m_axi_arlock(dma_128b_ar.lock),
        .m_axi_arcache(dma_128b_ar.cache),
        .m_axi_arprot(dma_128b_ar.prot),
        .m_axi_arqos(dma_128b_ar.qos),
        .m_axi_arregion(dma_128b_ar.region),
        .m_axi_aruser(dma_128b_ar.user),
        .m_axi_arvalid(dma_128b_arvalid),
        .m_axi_arready(dma_128b_arready),
        .m_axi_rid(dma_128b_r.id),
        .m_axi_rdata(dma_128b_r.data),
        .m_axi_rresp(dma_128b_r.resp),
        .m_axi_rlast(dma_128b_r.last),
        .m_axi_ruser(dma_128b_r.user),
        .m_axi_rvalid(dma_128b_rvalid),
        .m_axi_rready(dma_128b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            ...
            4'b0100: begin  // Slave 2 (64b)
                fub_axi_awready = dma_64b_awready;
            end
            4'b0010: begin  // Slave 1 (128b)
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            4'b0100: begin  // Slave 2 (64b)
                fub_axi_bid = dma_64b_b.id;
                fub_axi_bresp = dma_64b_b.resp;
                fub_axi_bvalid = dma_64b_bvalid;
            end
            4'b0010: begin  // Slave 1 (128b)
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            4'b0100: begin  // Slave 2 (64b)
                fub_axi_arready = dma_64b_arready;
            end
            4'b0010: begin  // Slave 1 (128b)
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            4'b0100: begin  // Slave 2 (64b)
                fub_axi_rid = dma_64b_r.id;
                fub_axi_rdata = dma_64b_r.data;
                fub_axi_rresp = dma_64b_r.resp;
                fub_axi_rlast = dma_64b_r.last;
                fub_axi_rvalid = dma_64b_rvalid;
            end
            4'b0010: begin  // Slave 1 (128b)
