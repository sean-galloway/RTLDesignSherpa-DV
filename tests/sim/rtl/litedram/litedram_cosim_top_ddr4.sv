...
//
// Wraps:
//   - litedram_dfi_wrapper_ddr4 (real MC + behavioral PHY/DRAM model)
...
module litedram_cosim_top_ddr4 #(
    // DDR4 widths: 15-bit row address, 128-bit wrdata, 16-bit mask
    ...
    parameter int DATA_MASK_BITS    = 16,
    ...
    output logic [14:0]  dfi_p0_address, dfi_p1_address, dfi_p2_address, dfi_p3_address,
    ...
    output logic [127:0] dfi_p0_wrdata,  dfi_p1_wrdata,  dfi_p2_wrdata,  dfi_p3_wrdata,
    output logic         dfi_p0_wrdata_en, dfi_p1_wrdata_en,
                         dfi_p2_wrdata_en, dfi_p3_wrdata_en,
    output logic [15:0]  dfi_p0_wrdata_mask, dfi_p1_wrdata_mask,
                         dfi_p2_wrdata_mask, dfi_p3_wrdata_mask,
    output logic [127:0] dfi_p0_rddata,  dfi_p1_rddata,  dfi_p2_rddata,  dfi_p3_rddata,
    ...
    litedram_dfi_wrapper_ddr4 litedram_inst (
