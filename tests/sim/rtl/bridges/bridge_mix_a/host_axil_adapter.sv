...
#(
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr >= 32'h40000000 && fub_axi_awaddr <= 32'h4000FFFF) begin
            comb_slave_select_aw[1] = 1'b1;  // axil_periph
        end
    ...
    always_comb begin
        ...
        if (fub_axi_araddr >= 32'h40000000 && fub_axi_araddr <= 32'h4000FFFF) begin
            comb_slave_select_ar[1] = 1'b1;  // axil_periph
        end
