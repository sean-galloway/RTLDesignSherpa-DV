...
#(
    ...
    // Slave 4 (axil_periph1): 0x90010000 - 0x9001FFFF
    // Slave 5 (apb_periph0): 0xA0000000 - 0xA000FFFF
    // ================================================================
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr <= 32'h3FFFFFFF) begin
            ...
            comb_slave_select_aw[4] = 1'b1;  // axil_periph1
        end
        else if (fub_axi_awaddr >= 32'hA0000000 && fub_axi_awaddr <= 32'hA000FFFF) begin
            comb_slave_select_aw[5] = 1'b1;  // apb_periph0
        end
    end
    ...
    always_comb begin
        ...
        if (fub_axi_araddr <= 32'h3FFFFFFF) begin
            ...
            comb_slave_select_ar[4] = 1'b1;  // axil_periph1
        end
        else if (fub_axi_araddr >= 32'hA0000000 && fub_axi_araddr <= 32'hA000FFFF) begin
            comb_slave_select_ar[5] = 1'b1;  // apb_periph0
        end
    end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[3] | comb_slave_select_aw[4] | comb_slave_select_aw[5]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[3] | w_slave_select[4] | w_slave_select[5];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[3] | comb_slave_select_ar[4] | comb_slave_select_ar[5]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[3] | b_slave_select[4] | b_slave_select[5];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[3] | r_slave_select[4] | r_slave_select[5];
