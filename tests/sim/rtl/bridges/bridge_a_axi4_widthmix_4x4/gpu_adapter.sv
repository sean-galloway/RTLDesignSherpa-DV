...
#(
    ...
    // Requests: fub_axi_* → gpu_128b_*
    // Responses: gpu_128b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign gpu_128b_aw.id     = fub_axi_awid;
    assign gpu_128b_aw.addr   = fub_axi_awaddr;
    assign gpu_128b_aw.len    = fub_axi_awlen;
    assign gpu_128b_aw.size   = fub_axi_awsize;
    assign gpu_128b_aw.burst  = fub_axi_awburst;
    assign gpu_128b_aw.lock   = fub_axi_awlock;
    assign gpu_128b_aw.cache  = fub_axi_awcache;
    assign gpu_128b_aw.prot   = fub_axi_awprot;
    assign gpu_128b_aw.qos    = 4'b0;  // Tie to 0
    assign gpu_128b_aw.region = 4'b0;  // Tie to 0
    assign gpu_128b_aw.user   = 1'b0;  // Tie to 0
    assign gpu_128b_awvalid   = fub_axi_awvalid && aw_path_active_128b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign gpu_128b_w.data  = fub_axi_wdata;
    assign gpu_128b_w.strb  = fub_axi_wstrb;
    assign gpu_128b_w.last  = fub_axi_wlast;
    assign gpu_128b_w.user  = 1'b0;  // Tie to 0
    assign gpu_128b_wvalid  = fub_axi_wvalid && w_path_active_128b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign gpu_128b_bready = fub_axi_bready && b_path_active_128b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign gpu_128b_ar.id     = fub_axi_arid;
    assign gpu_128b_ar.addr   = fub_axi_araddr;
    assign gpu_128b_ar.len    = fub_axi_arlen;
    assign gpu_128b_ar.size   = fub_axi_arsize;
    assign gpu_128b_ar.burst  = fub_axi_arburst;
    assign gpu_128b_ar.lock   = fub_axi_arlock;
    assign gpu_128b_ar.cache  = fub_axi_arcache;
    assign gpu_128b_ar.prot   = fub_axi_arprot;
    assign gpu_128b_ar.qos    = 4'b0;  // Tie to 0
    assign gpu_128b_ar.region = 4'b0;  // Tie to 0
    assign gpu_128b_ar.user   = 1'b0;  // Tie to 0
    assign gpu_128b_arvalid   = fub_axi_arvalid && ar_path_active_128b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign gpu_128b_rready = fub_axi_rready && r_path_active_128b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(gpu_256b_aw.id),
        .m_axi_awaddr(gpu_256b_aw.addr),
        .m_axi_awlen(gpu_256b_aw.len),
        .m_axi_awsize(gpu_256b_aw.size),
        .m_axi_awburst(gpu_256b_aw.burst),
        .m_axi_awlock(gpu_256b_aw.lock),
        .m_axi_awcache(gpu_256b_aw.cache),
        .m_axi_awprot(gpu_256b_aw.prot),
        .m_axi_awqos(gpu_256b_aw.qos),
        .m_axi_awregion(gpu_256b_aw.region),
        .m_axi_awuser(gpu_256b_aw.user),
        .m_axi_awvalid(gpu_256b_awvalid),
        .m_axi_awready(gpu_256b_awready),
        .m_axi_wdata(gpu_256b_w.data),
        .m_axi_wstrb(gpu_256b_w.strb),
        .m_axi_wlast(gpu_256b_w.last),
        .m_axi_wuser(gpu_256b_w.user),
        .m_axi_wvalid(gpu_256b_wvalid),
        .m_axi_wready(gpu_256b_wready),
        .m_axi_bid(gpu_256b_b.id),
        .m_axi_bresp(gpu_256b_b.resp),
        .m_axi_buser(gpu_256b_b.user),
        .m_axi_bvalid(gpu_256b_bvalid),
        .m_axi_bready(gpu_256b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(gpu_256b_ar.id),
        .m_axi_araddr(gpu_256b_ar.addr),
        .m_axi_arlen(gpu_256b_ar.len),
        .m_axi_arsize(gpu_256b_ar.size),
        .m_axi_arburst(gpu_256b_ar.burst),
        .m_axi_arlock(gpu_256b_ar.lock),
        .m_axi_arcache(gpu_256b_ar.cache),
        .m_axi_arprot(gpu_256b_ar.prot),
        .m_axi_arqos(gpu_256b_ar.qos),
        .m_axi_arregion(gpu_256b_ar.region),
        .m_axi_aruser(gpu_256b_ar.user),
        .m_axi_arvalid(gpu_256b_arvalid),
        .m_axi_arready(gpu_256b_arready),
        .m_axi_rid(gpu_256b_r.id),
        .m_axi_rdata(gpu_256b_r.data),
        .m_axi_rresp(gpu_256b_r.resp),
        .m_axi_rlast(gpu_256b_r.last),
        .m_axi_ruser(gpu_256b_r.user),
        .m_axi_rvalid(gpu_256b_rvalid),
        .m_axi_rready(gpu_256b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            ...
            4'b0010: begin  // Slave 1 (128b)
                fub_axi_awready = gpu_128b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            ...
            4'b0010: begin  // Slave 1 (128b)
                fub_axi_wready = gpu_128b_wready;
            end
            4'b0001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            4'b0010: begin  // Slave 1 (128b)
                fub_axi_bid = gpu_128b_b.id;
                fub_axi_bresp = gpu_128b_b.resp;
                fub_axi_bvalid = gpu_128b_bvalid;
            end
            4'b0001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            4'b0010: begin  // Slave 1 (128b)
                fub_axi_arready = gpu_128b_arready;
            end
            4'b0001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            4'b0010: begin  // Slave 1 (128b)
                fub_axi_rid = gpu_128b_r.id;
                fub_axi_rdata = gpu_128b_r.data;
                fub_axi_rresp = gpu_128b_r.resp;
                fub_axi_rlast = gpu_128b_r.last;
                fub_axi_rvalid = gpu_128b_rvalid;
            end
            4'b0001: begin  // Slave 0 (256b)
