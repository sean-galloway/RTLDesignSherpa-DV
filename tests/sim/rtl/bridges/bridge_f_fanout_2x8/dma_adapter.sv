...
#(
    ...
    assign aw_path_active_32b = comb_slave_select_aw[4] | comb_slave_select_aw[6];
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[4] | w_slave_select[6];
    logic ar_path_active_32b;
    assign ar_path_active_32b = comb_slave_select_ar[4] | comb_slave_select_ar[6];
    ...
    assign dma_128b_bready = fub_axi_bready;
    ...
    assign dma_128b_rready = fub_axi_rready;
