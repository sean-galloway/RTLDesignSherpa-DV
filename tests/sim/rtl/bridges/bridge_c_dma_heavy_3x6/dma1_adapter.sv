...
module dma1_adapter #(
    ...
    assign aw_path_active_32b = comb_slave_select_aw[4];
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[4];
    logic ar_path_active_32b;
    assign ar_path_active_32b = comb_slave_select_ar[4];
    ...
    assign dma1_128b_bready = fub_axi_bready;
    ...
    assign dma1_128b_rready = fub_axi_rready;
