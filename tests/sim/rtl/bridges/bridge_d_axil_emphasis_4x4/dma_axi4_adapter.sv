...
#(
    ...
    output axi4_aw_t     dma_axi4_32b_aw,
    output logic         dma_axi4_32b_awvalid,
    input  logic         dma_axi4_32b_awready,

    output axi4_w_32b_t  dma_axi4_32b_w,
    output logic         dma_axi4_32b_wvalid,
    input  logic         dma_axi4_32b_wready,

    input  axi4_b_t      dma_axi4_32b_b,
    input  logic         dma_axi4_32b_bvalid,
    output logic         dma_axi4_32b_bready,

    output axi4_ar_t     dma_axi4_32b_ar,
    output logic         dma_axi4_32b_arvalid,
    input  logic         dma_axi4_32b_arready,

    input  axi4_r_32b_t  dma_axi4_32b_r,
    input  logic         dma_axi4_32b_rvalid,
    output logic         dma_axi4_32b_rready,
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[1] | comb_slave_select_aw[2]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[1] | w_slave_select[2];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[1] | comb_slave_select_ar[2]) && ar_gate_ok;
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awid(dma_axi4_32b_aw.id),
        .m_axi_awaddr(dma_axi4_32b_aw.addr),
        .m_axi_awlen(dma_axi4_32b_aw.len),
        .m_axi_awsize(dma_axi4_32b_aw.size),
        .m_axi_awburst(dma_axi4_32b_aw.burst),
        .m_axi_awlock(dma_axi4_32b_aw.lock),
        .m_axi_awcache(dma_axi4_32b_aw.cache),
        .m_axi_awprot(dma_axi4_32b_aw.prot),
        .m_axi_awqos(dma_axi4_32b_aw.qos),
        .m_axi_awregion(dma_axi4_32b_aw.region),
        .m_axi_awuser(dma_axi4_32b_aw.user),
        .m_axi_awvalid(dma_axi4_32b_awvalid),
        .m_axi_awready(dma_axi4_32b_awready),
        .m_axi_wdata(dma_axi4_32b_w.data),
        .m_axi_wstrb(dma_axi4_32b_w.strb),
        .m_axi_wlast(dma_axi4_32b_w.last),
        .m_axi_wuser(dma_axi4_32b_w.user),
        .m_axi_wvalid(dma_axi4_32b_wvalid),
        .m_axi_wready(dma_axi4_32b_wready),
        .m_axi_bid(dma_axi4_32b_b.id),
        .m_axi_bresp(dma_axi4_32b_b.resp),
        .m_axi_buser(dma_axi4_32b_b.user),
        .m_axi_bvalid(dma_axi4_32b_bvalid),
        .m_axi_bready(dma_axi4_32b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma_axi4_32b_ar.id),
        .m_axi_araddr(dma_axi4_32b_ar.addr),
        .m_axi_arlen(dma_axi4_32b_ar.len),
        .m_axi_arsize(dma_axi4_32b_ar.size),
        .m_axi_arburst(dma_axi4_32b_ar.burst),
        .m_axi_arlock(dma_axi4_32b_ar.lock),
        .m_axi_arcache(dma_axi4_32b_ar.cache),
        .m_axi_arprot(dma_axi4_32b_ar.prot),
        .m_axi_arqos(dma_axi4_32b_ar.qos),
        .m_axi_arregion(dma_axi4_32b_ar.region),
        .m_axi_aruser(dma_axi4_32b_ar.user),
        .m_axi_arvalid(dma_axi4_32b_arvalid),
        .m_axi_arready(dma_axi4_32b_arready),
        .m_axi_rid(dma_axi4_32b_r.id),
        .m_axi_rdata(dma_axi4_32b_r.data),
        .m_axi_rresp(dma_axi4_32b_r.resp),
        .m_axi_rlast(dma_axi4_32b_r.last),
        .m_axi_ruser(dma_axi4_32b_r.user),
        .m_axi_rvalid(dma_axi4_32b_rvalid),
        .m_axi_rready(dma_axi4_32b_rready)
    );
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(dma_axi4_128b_aw.id),
        .m_axi_awaddr(dma_axi4_128b_aw.addr),
        .m_axi_awlen(dma_axi4_128b_aw.len),
        .m_axi_awsize(dma_axi4_128b_aw.size),
        .m_axi_awburst(dma_axi4_128b_aw.burst),
        .m_axi_awlock(dma_axi4_128b_aw.lock),
        .m_axi_awcache(dma_axi4_128b_aw.cache),
        .m_axi_awprot(dma_axi4_128b_aw.prot),
        .m_axi_awqos(dma_axi4_128b_aw.qos),
        .m_axi_awregion(dma_axi4_128b_aw.region),
        .m_axi_awuser(dma_axi4_128b_aw.user),
        .m_axi_awvalid(dma_axi4_128b_awvalid),
        .m_axi_awready(dma_axi4_128b_awready),
        .m_axi_wdata(dma_axi4_128b_w.data),
        .m_axi_wstrb(dma_axi4_128b_w.strb),
        .m_axi_wlast(dma_axi4_128b_w.last),
        .m_axi_wuser(dma_axi4_128b_w.user),
        .m_axi_wvalid(dma_axi4_128b_wvalid),
        .m_axi_wready(dma_axi4_128b_wready),
        .m_axi_bid(dma_axi4_128b_b.id),
        .m_axi_bresp(dma_axi4_128b_b.resp),
        .m_axi_buser(dma_axi4_128b_b.user),
        .m_axi_bvalid(dma_axi4_128b_bvalid),
        .m_axi_bready(dma_axi4_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma_axi4_128b_ar.id),
        .m_axi_araddr(dma_axi4_128b_ar.addr),
        .m_axi_arlen(dma_axi4_128b_ar.len),
        .m_axi_arsize(dma_axi4_128b_ar.size),
        .m_axi_arburst(dma_axi4_128b_ar.burst),
        .m_axi_arlock(dma_axi4_128b_ar.lock),
        .m_axi_arcache(dma_axi4_128b_ar.cache),
        .m_axi_arprot(dma_axi4_128b_ar.prot),
        .m_axi_arqos(dma_axi4_128b_ar.qos),
        .m_axi_arregion(dma_axi4_128b_ar.region),
        .m_axi_aruser(dma_axi4_128b_ar.user),
        .m_axi_arvalid(dma_axi4_128b_arvalid),
        .m_axi_arready(dma_axi4_128b_arready),
        .m_axi_rid(dma_axi4_128b_r.id),
        .m_axi_rdata(dma_axi4_128b_r.data),
        .m_axi_rresp(dma_axi4_128b_r.resp),
        .m_axi_rlast(dma_axi4_128b_r.last),
        .m_axi_ruser(dma_axi4_128b_r.user),
        .m_axi_rvalid(dma_axi4_128b_rvalid),
        .m_axi_rready(dma_axi4_128b_rready)
    );
