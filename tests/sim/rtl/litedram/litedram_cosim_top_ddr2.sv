...
//
// DDR2 cosim_top — 2-phase LiteDRAM core + dfi_shim passthrough.
// phy_clk runs 2× clk for the 1:2 gear ratio.

module litedram_cosim_top_ddr2 #(
    ...
    // 2-phase DFI from LiteDRAM (cocotb sampler reads)
    output logic [12:0]  dfi_p0_address, dfi_p1_address,
    output logic [2:0]   dfi_p0_bank,    dfi_p1_bank,
    output logic         dfi_p0_cas_n,   dfi_p1_cas_n,
    output logic         dfi_p0_cke,     dfi_p1_cke,
    output logic         dfi_p0_cs_n,    dfi_p1_cs_n,
    output logic         dfi_p0_odt,     dfi_p1_odt,
    output logic         dfi_p0_ras_n,   dfi_p1_ras_n,
    output logic         dfi_p0_reset_n, dfi_p1_reset_n,
    output logic         dfi_p0_we_n,    dfi_p1_we_n,
    output logic [31:0]  dfi_p0_wrdata,  dfi_p1_wrdata,
    output logic         dfi_p0_wrdata_en, dfi_p1_wrdata_en,
    output logic [3:0]   dfi_p0_wrdata_mask, dfi_p1_wrdata_mask,
    output logic [31:0]  dfi_p0_rddata,  dfi_p1_rddata,
    ...
    litedram_dfi_wrapper_ddr2 litedram_inst (
