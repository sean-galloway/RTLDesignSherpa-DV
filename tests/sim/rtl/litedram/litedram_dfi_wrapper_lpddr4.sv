...
//
// LPDDR4 variant of litedram_dfi_wrapper — 4-phase DFI (1:4 gear),
// 15-bit address (MT53E256M16D1: 15 row bits). Same out-of-module
// reference pattern as the DDR3 wrapper. Generated core comes from
// gen_lpddr4_sim.py (see that file for the LPDDR4-vs-litedram_gen
// workarounds).

module litedram_dfi_wrapper_lpddr4 (
    // ----- Clock + reset + status -----
