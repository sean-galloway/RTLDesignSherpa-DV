// DEBUG_AXIL Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for debug_axil master

`timescale 1ns / 1ps


module debug_axil_adapter
...
#(
    ...
    // External AXI interface (from debug_axil master)
    input  logic         debug_axil_awid,
    input  logic [31:0]  debug_axil_awaddr,
    input  logic [7:0]  debug_axil_awlen,
    input  logic [2:0]  debug_axil_awsize,
    input  logic [1:0]  debug_axil_awburst,
    input  logic         debug_axil_awlock,
    input  logic [3:0]  debug_axil_awcache,
    input  logic [2:0]  debug_axil_awprot,
    input  logic [3:0]  debug_axil_awqos,
    input  logic [3:0]  debug_axil_awregion,
    input  logic         debug_axil_awuser,
    ...
    input  logic         debug_axil_wlast,
    input  logic         debug_axil_wuser,
    input  logic         debug_axil_wvalid,
    output  logic         debug_axil_wready,

    output  logic         debug_axil_bid,
    output  logic [1:0]  debug_axil_bresp,
    output  logic         debug_axil_buser,
    output  logic         debug_axil_bvalid,
    input  logic         debug_axil_bready,

    input  logic         debug_axil_arid,
    input  logic [31:0]  debug_axil_araddr,
    input  logic [7:0]  debug_axil_arlen,
    input  logic [2:0]  debug_axil_arsize,
    input  logic [1:0]  debug_axil_arburst,
    input  logic         debug_axil_arlock,
    input  logic [3:0]  debug_axil_arcache,
    input  logic [2:0]  debug_axil_arprot,
    input  logic [3:0]  debug_axil_arqos,
    input  logic [3:0]  debug_axil_arregion,
    input  logic         debug_axil_aruser,
    input  logic         debug_axil_arvalid,
    output  logic         debug_axil_arready,

    output  logic         debug_axil_rid,
    output  logic [31:0]  debug_axil_rdata,
    output  logic [1:0]  debug_axil_rresp,
    output  logic         debug_axil_rlast,
    output  logic         debug_axil_ruser,
    ...
    output axi4_aw_t     debug_axil_32b_aw,
    output logic         debug_axil_32b_awvalid,
    input  logic         debug_axil_32b_awready,

    output axi4_w_32b_t  debug_axil_32b_w,
    output logic         debug_axil_32b_wvalid,
    input  logic         debug_axil_32b_wready,

    input  axi4_b_t      debug_axil_32b_b,
    input  logic         debug_axil_32b_bvalid,
    output logic         debug_axil_32b_bready,

    output axi4_ar_t     debug_axil_32b_ar,
    output logic         debug_axil_32b_arvalid,
    input  logic         debug_axil_32b_arready,

    input  axi4_r_32b_t  debug_axil_32b_r,
    input  logic         debug_axil_32b_rvalid,
    output logic         debug_axil_32b_rready,

    output axi4_aw_t     debug_axil_256b_aw,
    output logic         debug_axil_256b_awvalid,
    input  logic         debug_axil_256b_awready,

    output axi4_w_256b_t  debug_axil_256b_w,
    output logic         debug_axil_256b_wvalid,
    input  logic         debug_axil_256b_wready,

    input  axi4_b_t      debug_axil_256b_b,
    input  logic         debug_axil_256b_bvalid,
    output logic         debug_axil_256b_bready,

    output axi4_ar_t     debug_axil_256b_ar,
    output logic         debug_axil_256b_arvalid,
    input  logic         debug_axil_256b_arready,

    input  axi4_r_256b_t  debug_axil_256b_r,
    input  logic         debug_axil_256b_rvalid,
    output logic         debug_axil_256b_rready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(debug_axil_awid),
        .s_axi_awaddr(debug_axil_awaddr),
        .s_axi_awlen(debug_axil_awlen),
        .s_axi_awsize(debug_axil_awsize),
        .s_axi_awburst(debug_axil_awburst),
        .s_axi_awlock(debug_axil_awlock),
        .s_axi_awcache(debug_axil_awcache),
        .s_axi_awprot(debug_axil_awprot),
        .s_axi_awqos(debug_axil_awqos),
        .s_axi_awregion(debug_axil_awregion),
        .s_axi_awuser(debug_axil_awuser),
        .s_axi_awvalid(debug_axil_awvalid),
        .s_axi_awready(debug_axil_awready),
        .s_axi_wdata(debug_axil_wdata),
        .s_axi_wstrb(debug_axil_wstrb),
        .s_axi_wlast(debug_axil_wlast),
        .s_axi_wuser(debug_axil_wuser),
        .s_axi_wvalid(debug_axil_wvalid),
        .s_axi_wready(debug_axil_wready),
        .s_axi_bid(debug_axil_bid),
        .s_axi_bresp(debug_axil_bresp),
        .s_axi_buser(debug_axil_buser),
        .s_axi_bvalid(debug_axil_bvalid),
        .s_axi_bready(debug_axil_bready),
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(debug_axil_arid),
        .s_axi_araddr(debug_axil_araddr),
        .s_axi_arlen(debug_axil_arlen),
        .s_axi_arsize(debug_axil_arsize),
        .s_axi_arburst(debug_axil_arburst),
        .s_axi_arlock(debug_axil_arlock),
        .s_axi_arcache(debug_axil_arcache),
        .s_axi_arprot(debug_axil_arprot),
        .s_axi_arqos(debug_axil_arqos),
        .s_axi_arregion(debug_axil_arregion),
        .s_axi_aruser(debug_axil_aruser),
        .s_axi_arvalid(debug_axil_arvalid),
        .s_axi_arready(debug_axil_arready),
        .s_axi_rid(debug_axil_rid),
        .s_axi_rdata(debug_axil_rdata),
        .s_axi_rresp(debug_axil_rresp),
        .s_axi_rlast(debug_axil_rlast),
        .s_axi_ruser(debug_axil_ruser),
        .s_axi_rvalid(debug_axil_rvalid),
        .s_axi_rready(debug_axil_rready),
    ...
    // Slave 3 (axil_periph1): 0x90010000 - 0x9001FFFF
    ...
    always_comb begin
        ...
        if (fub_axi_awaddr <= 32'h3FFFFFFF) begin
            ...
            comb_slave_select_aw[3] = 1'b1;  // axil_periph1
        end
    ...
    always_comb begin
        ...
        if (fub_axi_araddr <= 32'h3FFFFFFF) begin
            ...
            comb_slave_select_ar[3] = 1'b1;  // axil_periph1
        end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[2] | comb_slave_select_aw[3] | comb_slave_select_aw[4]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[2] | w_slave_select[3] | w_slave_select[4];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[2] | comb_slave_select_ar[3] | comb_slave_select_ar[4]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[2] | b_slave_select[3] | b_slave_select[4];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[2] | r_slave_select[3] | r_slave_select[4];
    ...
    // Requests: fub_axi_* → debug_axil_32b_*
    // Responses: debug_axil_32b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign debug_axil_32b_aw.id     = fub_axi_awid;
    assign debug_axil_32b_aw.addr   = fub_axi_awaddr;
    assign debug_axil_32b_aw.len    = fub_axi_awlen;
    assign debug_axil_32b_aw.size   = fub_axi_awsize;
    assign debug_axil_32b_aw.burst  = fub_axi_awburst;
    assign debug_axil_32b_aw.lock   = fub_axi_awlock;
    assign debug_axil_32b_aw.cache  = fub_axi_awcache;
    assign debug_axil_32b_aw.prot   = fub_axi_awprot;
    assign debug_axil_32b_aw.qos    = 4'b0;  // Tie to 0
    assign debug_axil_32b_aw.region = 4'b0;  // Tie to 0
    assign debug_axil_32b_aw.user   = 1'b0;  // Tie to 0
    assign debug_axil_32b_awvalid   = fub_axi_awvalid && aw_path_active_32b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign debug_axil_32b_w.data  = fub_axi_wdata;
    assign debug_axil_32b_w.strb  = fub_axi_wstrb;
    assign debug_axil_32b_w.last  = fub_axi_wlast;
    assign debug_axil_32b_w.user  = 1'b0;  // Tie to 0
    assign debug_axil_32b_wvalid  = fub_axi_wvalid && w_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign debug_axil_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign debug_axil_32b_ar.id     = fub_axi_arid;
    assign debug_axil_32b_ar.addr   = fub_axi_araddr;
    assign debug_axil_32b_ar.len    = fub_axi_arlen;
    assign debug_axil_32b_ar.size   = fub_axi_arsize;
    assign debug_axil_32b_ar.burst  = fub_axi_arburst;
    assign debug_axil_32b_ar.lock   = fub_axi_arlock;
    assign debug_axil_32b_ar.cache  = fub_axi_arcache;
    assign debug_axil_32b_ar.prot   = fub_axi_arprot;
    assign debug_axil_32b_ar.qos    = 4'b0;  // Tie to 0
    assign debug_axil_32b_ar.region = 4'b0;  // Tie to 0
    assign debug_axil_32b_ar.user   = 1'b0;  // Tie to 0
    assign debug_axil_32b_arvalid   = fub_axi_arvalid && ar_path_active_32b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign debug_axil_32b_rready = fub_axi_rready && r_path_active_32b;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(debug_axil_256b_aw.id),
        .m_axi_awaddr(debug_axil_256b_aw.addr),
        .m_axi_awlen(debug_axil_256b_aw.len),
        .m_axi_awsize(debug_axil_256b_aw.size),
        .m_axi_awburst(debug_axil_256b_aw.burst),
        .m_axi_awlock(debug_axil_256b_aw.lock),
        .m_axi_awcache(debug_axil_256b_aw.cache),
        .m_axi_awprot(debug_axil_256b_aw.prot),
        .m_axi_awqos(debug_axil_256b_aw.qos),
        .m_axi_awregion(debug_axil_256b_aw.region),
        .m_axi_awuser(debug_axil_256b_aw.user),
        .m_axi_awvalid(debug_axil_256b_awvalid),
        .m_axi_awready(debug_axil_256b_awready),
        .m_axi_wdata(debug_axil_256b_w.data),
        .m_axi_wstrb(debug_axil_256b_w.strb),
        .m_axi_wlast(debug_axil_256b_w.last),
        .m_axi_wuser(debug_axil_256b_w.user),
        .m_axi_wvalid(debug_axil_256b_wvalid),
        .m_axi_wready(debug_axil_256b_wready),
        .m_axi_bid(debug_axil_256b_b.id),
        .m_axi_bresp(debug_axil_256b_b.resp),
        .m_axi_buser(debug_axil_256b_b.user),
        .m_axi_bvalid(debug_axil_256b_bvalid),
        .m_axi_bready(debug_axil_256b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(debug_axil_256b_ar.id),
        .m_axi_araddr(debug_axil_256b_ar.addr),
        .m_axi_arlen(debug_axil_256b_ar.len),
        .m_axi_arsize(debug_axil_256b_ar.size),
        .m_axi_arburst(debug_axil_256b_ar.burst),
        .m_axi_arlock(debug_axil_256b_ar.lock),
        .m_axi_arcache(debug_axil_256b_ar.cache),
        .m_axi_arprot(debug_axil_256b_ar.prot),
        .m_axi_arqos(debug_axil_256b_ar.qos),
        .m_axi_arregion(debug_axil_256b_ar.region),
        .m_axi_aruser(debug_axil_256b_ar.user),
        .m_axi_arvalid(debug_axil_256b_arvalid),
        .m_axi_arready(debug_axil_256b_arready),
        .m_axi_rid(debug_axil_256b_r.id),
        .m_axi_rdata(debug_axil_256b_r.data),
        .m_axi_rresp(debug_axil_256b_r.resp),
        .m_axi_rlast(debug_axil_256b_r.last),
        .m_axi_ruser(debug_axil_256b_r.user),
        .m_axi_rvalid(debug_axil_256b_rvalid),
        .m_axi_rready(debug_axil_256b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            5'b00100: begin  // Slave 2 (32b)
                fub_axi_awready = debug_axil_32b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            5'b00100: begin  // Slave 2 (32b)
                fub_axi_wready = debug_axil_32b_wready;
            end
            5'b01000: begin  // Slave 3 (32b)
                fub_axi_wready = debug_axil_32b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            5'b00100: begin  // Slave 2 (32b)
                fub_axi_bid = debug_axil_32b_b.id;
                fub_axi_bresp = debug_axil_32b_b.resp;
                fub_axi_bvalid = debug_axil_32b_bvalid;
            end
            5'b01000: begin  // Slave 3 (32b)
                fub_axi_bid = debug_axil_32b_b.id;
                fub_axi_bresp = debug_axil_32b_b.resp;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            5'b00100: begin  // Slave 2 (32b)
                fub_axi_arready = debug_axil_32b_arready;
            end
            5'b01000: begin  // Slave 3 (32b)
                fub_axi_arready = debug_axil_32b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            5'b00100: begin  // Slave 2 (32b)
                fub_axi_rid = debug_axil_32b_r.id;
                fub_axi_rdata = debug_axil_32b_r.data;
                fub_axi_rresp = debug_axil_32b_r.resp;
                fub_axi_rlast = debug_axil_32b_r.last;
                fub_axi_rvalid = debug_axil_32b_rvalid;
            end
            5'b01000: begin  // Slave 3 (32b)
                fub_axi_rid = debug_axil_32b_r.id;
                fub_axi_rdata = debug_axil_32b_r.data;
