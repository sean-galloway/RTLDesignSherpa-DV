...
#(
    ...
    output axi4_ar_t     cpu_64b_ar,
    output logic         cpu_64b_arvalid,
    input  logic         cpu_64b_arready,

    input  axi4_r_64b_t  cpu_64b_r,
    input  logic         cpu_64b_rvalid,
    output logic         cpu_64b_rready,

    output axi4_aw_t     cpu_128b_aw,
    output logic         cpu_128b_awvalid,
    input  logic         cpu_128b_awready,

    output axi4_w_128b_t  cpu_128b_w,
    ...
    output axi4_ar_t     cpu_128b_ar,
    output logic         cpu_128b_arvalid,
    input  logic         cpu_128b_arready,

    input  axi4_r_128b_t  cpu_128b_r,
    input  logic         cpu_128b_rvalid,
    output logic         cpu_128b_rready,

    output axi4_aw_t     cpu_256b_aw,
    output logic         cpu_256b_awvalid,
    input  logic         cpu_256b_awready,

    output axi4_w_256b_t  cpu_256b_w,
    output logic         cpu_256b_wvalid,
    input  logic         cpu_256b_wready,

    input  axi4_b_t      cpu_256b_b,
    input  logic         cpu_256b_bvalid,
    output logic         cpu_256b_bready,

    output axi4_ar_t     cpu_256b_ar,
    output logic         cpu_256b_arvalid,
    input  logic         cpu_256b_arready,

    input  axi4_r_256b_t  cpu_256b_r,
    input  logic         cpu_256b_rvalid,
    output logic         cpu_256b_rready
);
    ...
    // Slave 2 (sram): 0x80000000 - 0x80FFFFFF
    // Slave 3 (scratch): 0x81000000 - 0x81FFFFFF
    // Slave 4 (axil_periph0): 0x90000000 - 0x9000FFFF
    // Slave 5 (axil_periph1): 0x90010000 - 0x9001FFFF
    // Slave 6 (apb_periph0): 0xA0000000 - 0xA000FFFF
    // Slave 7 (apb_periph1): 0xA0010000 - 0xA001FFFF
    // ================================================================
    ...
    always_comb begin
        ...
        else if (fub_axi_awaddr >= 32'h80000000 && fub_axi_awaddr <= 32'h80FFFFFF) begin
            comb_slave_select_aw[2] = 1'b1;  // sram
        end
        else if (fub_axi_awaddr >= 32'h81000000 && fub_axi_awaddr <= 32'h81FFFFFF) begin
            comb_slave_select_aw[3] = 1'b1;  // scratch
        end
        else if (fub_axi_awaddr >= 32'h90000000 && fub_axi_awaddr <= 32'h9000FFFF) begin
            comb_slave_select_aw[4] = 1'b1;  // axil_periph0
        end
        else if (fub_axi_awaddr >= 32'h90010000 && fub_axi_awaddr <= 32'h9001FFFF) begin
            comb_slave_select_aw[5] = 1'b1;  // axil_periph1
        end
        else if (fub_axi_awaddr >= 32'hA0000000 && fub_axi_awaddr <= 32'hA000FFFF) begin
            comb_slave_select_aw[6] = 1'b1;  // apb_periph0
        end
        else if (fub_axi_awaddr >= 32'hA0010000 && fub_axi_awaddr <= 32'hA001FFFF) begin
            comb_slave_select_aw[7] = 1'b1;  // apb_periph1
        end
    end
    ...
    always_comb begin
        ...
        else if (fub_axi_araddr >= 32'h80000000 && fub_axi_araddr <= 32'h80FFFFFF) begin
            comb_slave_select_ar[2] = 1'b1;  // sram
        end
        else if (fub_axi_araddr >= 32'h81000000 && fub_axi_araddr <= 32'h81FFFFFF) begin
            comb_slave_select_ar[3] = 1'b1;  // scratch
        end
        else if (fub_axi_araddr >= 32'h90000000 && fub_axi_araddr <= 32'h9000FFFF) begin
            comb_slave_select_ar[4] = 1'b1;  // axil_periph0
        end
        else if (fub_axi_araddr >= 32'h90010000 && fub_axi_araddr <= 32'h9001FFFF) begin
            comb_slave_select_ar[5] = 1'b1;  // axil_periph1
        end
        else if (fub_axi_araddr >= 32'hA0000000 && fub_axi_araddr <= 32'hA000FFFF) begin
            comb_slave_select_ar[6] = 1'b1;  // apb_periph0
        end
        else if (fub_axi_araddr >= 32'hA0010000 && fub_axi_araddr <= 32'hA001FFFF) begin
            comb_slave_select_ar[7] = 1'b1;  // apb_periph1
        end
    end
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[4] | comb_slave_select_aw[5] | comb_slave_select_aw[6] | comb_slave_select_aw[7]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[4] | w_slave_select[5] | w_slave_select[6] | w_slave_select[7];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[4] | comb_slave_select_ar[5] | comb_slave_select_ar[6] | comb_slave_select_ar[7]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[4] | b_slave_select[5] | b_slave_select[6] | b_slave_select[7];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[4] | r_slave_select[5] | r_slave_select[6] | r_slave_select[7];
    logic aw_path_active_64b;
    assign aw_path_active_64b = (comb_slave_select_aw[2] | comb_slave_select_aw[3]) && aw_gate_ok;
    logic w_path_active_64b;
    assign w_path_active_64b = w_slave_select[2] | w_slave_select[3];
    logic ar_path_active_64b;
    assign ar_path_active_64b = (comb_slave_select_ar[2] | comb_slave_select_ar[3]) && ar_gate_ok;
    logic b_path_active_64b;
    assign b_path_active_64b = b_slave_select[2] | b_slave_select[3];
    logic r_path_active_64b;
    assign r_path_active_64b = r_slave_select[2] | r_slave_select[3];
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awid(cpu_32b_aw.id),
        .m_axi_awaddr(cpu_32b_aw.addr),
        .m_axi_awlen(cpu_32b_aw.len),
        .m_axi_awsize(cpu_32b_aw.size),
        .m_axi_awburst(cpu_32b_aw.burst),
        .m_axi_awlock(cpu_32b_aw.lock),
        .m_axi_awcache(cpu_32b_aw.cache),
        .m_axi_awprot(cpu_32b_aw.prot),
        .m_axi_awqos(cpu_32b_aw.qos),
        .m_axi_awregion(cpu_32b_aw.region),
        .m_axi_awuser(cpu_32b_aw.user),
        .m_axi_awvalid(cpu_32b_awvalid),
        .m_axi_awready(cpu_32b_awready),
        .m_axi_wdata(cpu_32b_w.data),
        .m_axi_wstrb(cpu_32b_w.strb),
        .m_axi_wlast(cpu_32b_w.last),
        .m_axi_wuser(cpu_32b_w.user),
        .m_axi_wvalid(cpu_32b_wvalid),
        .m_axi_wready(cpu_32b_wready),
        .m_axi_bid(cpu_32b_b.id),
        .m_axi_bresp(cpu_32b_b.resp),
        .m_axi_buser(cpu_32b_b.user),
        .m_axi_bvalid(cpu_32b_bvalid),
        .m_axi_bready(cpu_32b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(cpu_32b_ar.id),
        .m_axi_araddr(cpu_32b_ar.addr),
        .m_axi_arlen(cpu_32b_ar.len),
        .m_axi_arsize(cpu_32b_ar.size),
        .m_axi_arburst(cpu_32b_ar.burst),
        .m_axi_arlock(cpu_32b_ar.lock),
        .m_axi_arcache(cpu_32b_ar.cache),
        .m_axi_arprot(cpu_32b_ar.prot),
        .m_axi_arqos(cpu_32b_ar.qos),
        .m_axi_arregion(cpu_32b_ar.region),
        .m_axi_aruser(cpu_32b_ar.user),
        .m_axi_arvalid(cpu_32b_arvalid),
        .m_axi_arready(cpu_32b_arready),
        .m_axi_rid(cpu_32b_r.id),
        .m_axi_rdata(cpu_32b_r.data),
        .m_axi_rresp(cpu_32b_r.resp),
        .m_axi_rlast(cpu_32b_r.last),
        .m_axi_ruser(cpu_32b_r.user),
        .m_axi_rvalid(cpu_32b_rvalid),
        .m_axi_rready(cpu_32b_rready)
    );

    // ================================================================
    // Direct passthrough: 64b → 64b (no converter)
    // Requests: fub_axi_* → cpu_64b_*
    // Responses: cpu_64b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign cpu_64b_aw.id     = fub_axi_awid;
    assign cpu_64b_aw.addr   = fub_axi_awaddr;
    assign cpu_64b_aw.len    = fub_axi_awlen;
    assign cpu_64b_aw.size   = fub_axi_awsize;
    assign cpu_64b_aw.burst  = fub_axi_awburst;
    assign cpu_64b_aw.lock   = fub_axi_awlock;
    assign cpu_64b_aw.cache  = fub_axi_awcache;
    assign cpu_64b_aw.prot   = fub_axi_awprot;
    assign cpu_64b_aw.qos    = 4'b0;  // Tie to 0
    assign cpu_64b_aw.region = 4'b0;  // Tie to 0
    assign cpu_64b_aw.user   = 1'b0;  // Tie to 0
    assign cpu_64b_awvalid   = fub_axi_awvalid && aw_path_active_64b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign cpu_64b_w.data  = fub_axi_wdata;
    assign cpu_64b_w.strb  = fub_axi_wstrb;
    assign cpu_64b_w.last  = fub_axi_wlast;
    assign cpu_64b_w.user  = 1'b0;  // Tie to 0
    assign cpu_64b_wvalid  = fub_axi_wvalid && w_path_active_64b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign cpu_64b_bready = fub_axi_bready && b_path_active_64b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign cpu_64b_ar.id     = fub_axi_arid;
    assign cpu_64b_ar.addr   = fub_axi_araddr;
    assign cpu_64b_ar.len    = fub_axi_arlen;
    assign cpu_64b_ar.size   = fub_axi_arsize;
    assign cpu_64b_ar.burst  = fub_axi_arburst;
    assign cpu_64b_ar.lock   = fub_axi_arlock;
    assign cpu_64b_ar.cache  = fub_axi_arcache;
    assign cpu_64b_ar.prot   = fub_axi_arprot;
    assign cpu_64b_ar.qos    = 4'b0;  // Tie to 0
    assign cpu_64b_ar.region = 4'b0;  // Tie to 0
    assign cpu_64b_ar.user   = 1'b0;  // Tie to 0
    assign cpu_64b_arvalid   = fub_axi_arvalid && ar_path_active_64b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign cpu_64b_rready = fub_axi_rready && r_path_active_64b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        .s_axi_bready(fub_axi_bready && b_path_active_128b),

        // Master side (to crossbar)
        .m_axi_awid(cpu_128b_aw.id),
        .m_axi_awaddr(cpu_128b_aw.addr),
        .m_axi_awlen(cpu_128b_aw.len),
        .m_axi_awsize(cpu_128b_aw.size),
        .m_axi_awburst(cpu_128b_aw.burst),
        .m_axi_awlock(cpu_128b_aw.lock),
        .m_axi_awcache(cpu_128b_aw.cache),
        .m_axi_awprot(cpu_128b_aw.prot),
        .m_axi_awqos(cpu_128b_aw.qos),
        .m_axi_awregion(cpu_128b_aw.region),
        .m_axi_awuser(cpu_128b_aw.user),
        .m_axi_awvalid(cpu_128b_awvalid),
        .m_axi_awready(cpu_128b_awready),
        .m_axi_wdata(cpu_128b_w.data),
        .m_axi_wstrb(cpu_128b_w.strb),
        .m_axi_wlast(cpu_128b_w.last),
        .m_axi_wuser(cpu_128b_w.user),
        .m_axi_wvalid(cpu_128b_wvalid),
        .m_axi_wready(cpu_128b_wready),
        .m_axi_bid(cpu_128b_b.id),
        .m_axi_bresp(cpu_128b_b.resp),
        .m_axi_buser(cpu_128b_b.user),
        .m_axi_bvalid(cpu_128b_bvalid),
        .m_axi_bready(cpu_128b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(cpu_128b_ar.id),
        .m_axi_araddr(cpu_128b_ar.addr),
        .m_axi_arlen(cpu_128b_ar.len),
        .m_axi_arsize(cpu_128b_ar.size),
        .m_axi_arburst(cpu_128b_ar.burst),
        .m_axi_arlock(cpu_128b_ar.lock),
        .m_axi_arcache(cpu_128b_ar.cache),
        .m_axi_arprot(cpu_128b_ar.prot),
        .m_axi_arqos(cpu_128b_ar.qos),
        .m_axi_arregion(cpu_128b_ar.region),
        .m_axi_aruser(cpu_128b_ar.user),
        .m_axi_arvalid(cpu_128b_arvalid),
        .m_axi_arready(cpu_128b_arready),
        .m_axi_rid(cpu_128b_r.id),
        .m_axi_rdata(cpu_128b_r.data),
        .m_axi_rresp(cpu_128b_r.resp),
        .m_axi_rlast(cpu_128b_r.last),
        .m_axi_ruser(cpu_128b_r.user),
        .m_axi_rvalid(cpu_128b_rvalid),
        .m_axi_rready(cpu_128b_rready)
    );
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(cpu_256b_aw.id),
        .m_axi_awaddr(cpu_256b_aw.addr),
        .m_axi_awlen(cpu_256b_aw.len),
        .m_axi_awsize(cpu_256b_aw.size),
        .m_axi_awburst(cpu_256b_aw.burst),
        .m_axi_awlock(cpu_256b_aw.lock),
        .m_axi_awcache(cpu_256b_aw.cache),
        .m_axi_awprot(cpu_256b_aw.prot),
        .m_axi_awqos(cpu_256b_aw.qos),
        .m_axi_awregion(cpu_256b_aw.region),
        .m_axi_awuser(cpu_256b_aw.user),
        .m_axi_awvalid(cpu_256b_awvalid),
        .m_axi_awready(cpu_256b_awready),
        .m_axi_wdata(cpu_256b_w.data),
        .m_axi_wstrb(cpu_256b_w.strb),
        .m_axi_wlast(cpu_256b_w.last),
        .m_axi_wuser(cpu_256b_w.user),
        .m_axi_wvalid(cpu_256b_wvalid),
        .m_axi_wready(cpu_256b_wready),
        .m_axi_bid(cpu_256b_b.id),
        .m_axi_bresp(cpu_256b_b.resp),
        .m_axi_buser(cpu_256b_b.user),
        .m_axi_bvalid(cpu_256b_bvalid),
        .m_axi_bready(cpu_256b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(cpu_256b_ar.id),
        .m_axi_araddr(cpu_256b_ar.addr),
        .m_axi_arlen(cpu_256b_ar.len),
        .m_axi_arsize(cpu_256b_ar.size),
        .m_axi_arburst(cpu_256b_ar.burst),
        .m_axi_arlock(cpu_256b_ar.lock),
        .m_axi_arcache(cpu_256b_ar.cache),
        .m_axi_arprot(cpu_256b_ar.prot),
        .m_axi_arqos(cpu_256b_ar.qos),
        .m_axi_arregion(cpu_256b_ar.region),
        .m_axi_aruser(cpu_256b_ar.user),
        .m_axi_arvalid(cpu_256b_arvalid),
        .m_axi_arready(cpu_256b_arready),
        .m_axi_rid(cpu_256b_r.id),
        .m_axi_rdata(cpu_256b_r.data),
        .m_axi_rresp(cpu_256b_r.resp),
        .m_axi_rlast(cpu_256b_r.last),
        .m_axi_ruser(cpu_256b_r.user),
        .m_axi_rvalid(cpu_256b_rvalid),
        .m_axi_rready(cpu_256b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            8'b00010000: begin  // Slave 4 (32b)
                fub_axi_awready = conv_32b_awready;
            end
            8'b00100000: begin  // Slave 5 (32b)
                fub_axi_awready = conv_32b_awready;
            end
            8'b01000000: begin  // Slave 6 (32b)
                fub_axi_awready = conv_32b_awready;
            end
            8'b10000000: begin  // Slave 7 (32b)
                fub_axi_awready = conv_32b_awready;
            end
            8'b00000100: begin  // Slave 2 (64b)
                fub_axi_awready = cpu_64b_awready;
            end
            8'b00001000: begin  // Slave 3 (64b)
                fub_axi_awready = cpu_64b_awready;
            end
            8'b00000010: begin  // Slave 1 (128b)
                fub_axi_awready = conv_128b_awready;
            end
            8'b00000001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            8'b00000100: begin  // Slave 2 (64b)
                fub_axi_bid = cpu_64b_b.id;
                fub_axi_bresp = cpu_64b_b.resp;
                fub_axi_bvalid = cpu_64b_bvalid;
            end
            8'b00001000: begin  // Slave 3 (64b)
                fub_axi_bid = cpu_64b_b.id;
                fub_axi_bresp = cpu_64b_b.resp;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            8'b00000100: begin  // Slave 2 (64b)
                fub_axi_arready = cpu_64b_arready;
            end
            8'b00001000: begin  // Slave 3 (64b)
                fub_axi_arready = cpu_64b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            8'b00000100: begin  // Slave 2 (64b)
                fub_axi_rid = cpu_64b_r.id;
                fub_axi_rdata = cpu_64b_r.data;
                fub_axi_rresp = cpu_64b_r.resp;
                fub_axi_rlast = cpu_64b_r.last;
                fub_axi_rvalid = cpu_64b_rvalid;
            end
            8'b00001000: begin  // Slave 3 (64b)
                fub_axi_rid = cpu_64b_r.id;
                fub_axi_rdata = cpu_64b_r.data;
