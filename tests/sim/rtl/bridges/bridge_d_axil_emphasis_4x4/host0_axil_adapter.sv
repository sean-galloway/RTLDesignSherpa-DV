// HOST0_AXIL Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for host0_axil master

`timescale 1ns / 1ps


module host0_axil_adapter
...
#(
    ...
    // External AXI interface (from host0_axil master)
    input  logic         host0_axil_awid,
    input  logic [31:0]  host0_axil_awaddr,
    input  logic [7:0]  host0_axil_awlen,
    input  logic [2:0]  host0_axil_awsize,
    input  logic [1:0]  host0_axil_awburst,
    input  logic         host0_axil_awlock,
    input  logic [3:0]  host0_axil_awcache,
    input  logic [2:0]  host0_axil_awprot,
    input  logic [3:0]  host0_axil_awqos,
    input  logic [3:0]  host0_axil_awregion,
    input  logic         host0_axil_awuser,
    ...
    input  logic         host0_axil_wlast,
    input  logic         host0_axil_wuser,
    input  logic         host0_axil_wvalid,
    output  logic         host0_axil_wready,

    output  logic         host0_axil_bid,
    output  logic [1:0]  host0_axil_bresp,
    output  logic         host0_axil_buser,
    output  logic         host0_axil_bvalid,
    input  logic         host0_axil_bready,

    input  logic         host0_axil_arid,
    input  logic [31:0]  host0_axil_araddr,
    input  logic [7:0]  host0_axil_arlen,
    input  logic [2:0]  host0_axil_arsize,
    input  logic [1:0]  host0_axil_arburst,
    input  logic         host0_axil_arlock,
    input  logic [3:0]  host0_axil_arcache,
    input  logic [2:0]  host0_axil_arprot,
    input  logic [3:0]  host0_axil_arqos,
    input  logic [3:0]  host0_axil_arregion,
    input  logic         host0_axil_aruser,
    input  logic         host0_axil_arvalid,
    output  logic         host0_axil_arready,

    output  logic         host0_axil_rid,
    output  logic [31:0]  host0_axil_rdata,
    output  logic [1:0]  host0_axil_rresp,
    output  logic         host0_axil_rlast,
    output  logic         host0_axil_ruser,
    ...
    output axi4_aw_t     host0_axil_32b_aw,
    output logic         host0_axil_32b_awvalid,
    input  logic         host0_axil_32b_awready,

    output axi4_w_32b_t  host0_axil_32b_w,
    output logic         host0_axil_32b_wvalid,
    input  logic         host0_axil_32b_wready,

    input  axi4_b_t      host0_axil_32b_b,
    input  logic         host0_axil_32b_bvalid,
    output logic         host0_axil_32b_bready,

    output axi4_ar_t     host0_axil_32b_ar,
    output logic         host0_axil_32b_arvalid,
    input  logic         host0_axil_32b_arready,

    input  axi4_r_32b_t  host0_axil_32b_r,
    input  logic         host0_axil_32b_rvalid,
    output logic         host0_axil_32b_rready,

    output axi4_aw_t     host0_axil_128b_aw,
    output logic         host0_axil_128b_awvalid,
    input  logic         host0_axil_128b_awready,

    output axi4_w_128b_t  host0_axil_128b_w,
    output logic         host0_axil_128b_wvalid,
    input  logic         host0_axil_128b_wready,

    input  axi4_b_t      host0_axil_128b_b,
    input  logic         host0_axil_128b_bvalid,
    output logic         host0_axil_128b_bready,

    output axi4_ar_t     host0_axil_128b_ar,
    output logic         host0_axil_128b_arvalid,
    input  logic         host0_axil_128b_arready,

    input  axi4_r_128b_t  host0_axil_128b_r,
    input  logic         host0_axil_128b_rvalid,
    output logic         host0_axil_128b_rready
);
    ...
    axi4_slave_wr #(
        ...
        // External side (s_axi)
        .s_axi_awid(host0_axil_awid),
        .s_axi_awaddr(host0_axil_awaddr),
        .s_axi_awlen(host0_axil_awlen),
        .s_axi_awsize(host0_axil_awsize),
        .s_axi_awburst(host0_axil_awburst),
        .s_axi_awlock(host0_axil_awlock),
        .s_axi_awcache(host0_axil_awcache),
        .s_axi_awprot(host0_axil_awprot),
        .s_axi_awqos(host0_axil_awqos),
        .s_axi_awregion(host0_axil_awregion),
        .s_axi_awuser(host0_axil_awuser),
        .s_axi_awvalid(host0_axil_awvalid),
        .s_axi_awready(host0_axil_awready),
        .s_axi_wdata(host0_axil_wdata),
        .s_axi_wstrb(host0_axil_wstrb),
        .s_axi_wlast(host0_axil_wlast),
        .s_axi_wuser(host0_axil_wuser),
        .s_axi_wvalid(host0_axil_wvalid),
        .s_axi_wready(host0_axil_wready),
        .s_axi_bid(host0_axil_bid),
        .s_axi_bresp(host0_axil_bresp),
        .s_axi_buser(host0_axil_buser),
        .s_axi_bvalid(host0_axil_bvalid),
        .s_axi_bready(host0_axil_bready),
    ...
    axi4_slave_rd #(
        ...
        // External side (s_axi)
        .s_axi_arid(host0_axil_arid),
        .s_axi_araddr(host0_axil_araddr),
        .s_axi_arlen(host0_axil_arlen),
        .s_axi_arsize(host0_axil_arsize),
        .s_axi_arburst(host0_axil_arburst),
        .s_axi_arlock(host0_axil_arlock),
        .s_axi_arcache(host0_axil_arcache),
        .s_axi_arprot(host0_axil_arprot),
        .s_axi_arqos(host0_axil_arqos),
        .s_axi_arregion(host0_axil_arregion),
        .s_axi_aruser(host0_axil_aruser),
        .s_axi_arvalid(host0_axil_arvalid),
        .s_axi_arready(host0_axil_arready),
        .s_axi_rid(host0_axil_rid),
        .s_axi_rdata(host0_axil_rdata),
        .s_axi_rresp(host0_axil_rresp),
        .s_axi_rlast(host0_axil_rlast),
        .s_axi_ruser(host0_axil_ruser),
        .s_axi_rvalid(host0_axil_rvalid),
        .s_axi_rready(host0_axil_rready),
    ...
    // Slave 1 (axil_periph0): 0x90000000 - 0x9000FFFF
    // Slave 2 (axil_periph1): 0x90010000 - 0x9001FFFF
    // Slave 3 (apb_periph0): 0xA0000000 - 0xA000FFFF
    // ================================================================
    ...
    // Connected to slaves with widths: [32, 128]
    // ================================================================
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[1] | comb_slave_select_aw[2] | comb_slave_select_aw[3]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[1] | w_slave_select[2] | w_slave_select[3];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[1] | comb_slave_select_ar[2] | comb_slave_select_ar[3]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[1] | b_slave_select[2] | b_slave_select[3];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[1] | r_slave_select[2] | r_slave_select[3];
    ...
    // Requests: fub_axi_* → host0_axil_32b_*
    // Responses: host0_axil_32b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign host0_axil_32b_aw.id     = fub_axi_awid;
    assign host0_axil_32b_aw.addr   = fub_axi_awaddr;
    assign host0_axil_32b_aw.len    = fub_axi_awlen;
    assign host0_axil_32b_aw.size   = fub_axi_awsize;
    assign host0_axil_32b_aw.burst  = fub_axi_awburst;
    assign host0_axil_32b_aw.lock   = fub_axi_awlock;
    assign host0_axil_32b_aw.cache  = fub_axi_awcache;
    assign host0_axil_32b_aw.prot   = fub_axi_awprot;
    assign host0_axil_32b_aw.qos    = 4'b0;  // Tie to 0
    assign host0_axil_32b_aw.region = 4'b0;  // Tie to 0
    assign host0_axil_32b_aw.user   = 1'b0;  // Tie to 0
    assign host0_axil_32b_awvalid   = fub_axi_awvalid && aw_path_active_32b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign host0_axil_32b_w.data  = fub_axi_wdata;
    assign host0_axil_32b_w.strb  = fub_axi_wstrb;
    assign host0_axil_32b_w.last  = fub_axi_wlast;
    assign host0_axil_32b_w.user  = 1'b0;  // Tie to 0
    assign host0_axil_32b_wvalid  = fub_axi_wvalid && w_path_active_32b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign host0_axil_32b_bready = fub_axi_bready && b_path_active_32b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign host0_axil_32b_ar.id     = fub_axi_arid;
    assign host0_axil_32b_ar.addr   = fub_axi_araddr;
    assign host0_axil_32b_ar.len    = fub_axi_arlen;
    assign host0_axil_32b_ar.size   = fub_axi_arsize;
    assign host0_axil_32b_ar.burst  = fub_axi_arburst;
    assign host0_axil_32b_ar.lock   = fub_axi_arlock;
    assign host0_axil_32b_ar.cache  = fub_axi_arcache;
    assign host0_axil_32b_ar.prot   = fub_axi_arprot;
    assign host0_axil_32b_ar.qos    = 4'b0;  // Tie to 0
    assign host0_axil_32b_ar.region = 4'b0;  // Tie to 0
    assign host0_axil_32b_ar.user   = 1'b0;  // Tie to 0
    assign host0_axil_32b_arvalid   = fub_axi_arvalid && ar_path_active_32b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign host0_axil_32b_rready = fub_axi_rready && r_path_active_32b;
    // rid, rdata, rresp, rlast, rvalid routed via MUX (user field ignored)

    // ================================================================
    // Width converter: 32b → 128b
    // ================================================================

    // Intermediate signals for 128b converter
    logic conv_128b_awready;
    logic conv_128b_wready;
    logic [-1:0] conv_128b_bid;
    logic [1:0] conv_128b_bresp;
    logic conv_128b_bvalid;
    logic conv_128b_arready;
    logic [-1:0] conv_128b_rid;
    logic [31:0] conv_128b_rdata;
    ...
    axil_to_axi4_wide_align_wr #(
        ...
        .m_axi_awid(host0_axil_128b_aw.id),
        .m_axi_awaddr(host0_axil_128b_aw.addr),
        .m_axi_awlen(host0_axil_128b_aw.len),
        .m_axi_awsize(host0_axil_128b_aw.size),
        .m_axi_awburst(host0_axil_128b_aw.burst),
        .m_axi_awlock(host0_axil_128b_aw.lock),
        .m_axi_awcache(host0_axil_128b_aw.cache),
        .m_axi_awprot(host0_axil_128b_aw.prot),
        .m_axi_awqos(host0_axil_128b_aw.qos),
        .m_axi_awregion(host0_axil_128b_aw.region),
        .m_axi_awuser(host0_axil_128b_aw.user),
        .m_axi_awvalid(host0_axil_128b_awvalid),
        .m_axi_awready(host0_axil_128b_awready),
        .m_axi_wdata(host0_axil_128b_w.data),
        .m_axi_wstrb(host0_axil_128b_w.strb),
        .m_axi_wlast(host0_axil_128b_w.last),
        .m_axi_wuser(host0_axil_128b_w.user),
        .m_axi_wvalid(host0_axil_128b_wvalid),
        .m_axi_wready(host0_axil_128b_wready),
        .m_axi_bid(host0_axil_128b_b.id),
        .m_axi_bresp(host0_axil_128b_b.resp),
        .m_axi_buser(host0_axil_128b_b.user),
        .m_axi_bvalid(host0_axil_128b_bvalid),
        .m_axi_bready(host0_axil_128b_bready)
    );
    ...
    axil_to_axi4_wide_align_rd #(
        ...
        .m_axi_arid(host0_axil_128b_ar.id),
        .m_axi_araddr(host0_axil_128b_ar.addr),
        .m_axi_arlen(host0_axil_128b_ar.len),
        .m_axi_arsize(host0_axil_128b_ar.size),
        .m_axi_arburst(host0_axil_128b_ar.burst),
        .m_axi_arlock(host0_axil_128b_ar.lock),
        .m_axi_arcache(host0_axil_128b_ar.cache),
        .m_axi_arprot(host0_axil_128b_ar.prot),
        .m_axi_arqos(host0_axil_128b_ar.qos),
        .m_axi_arregion(host0_axil_128b_ar.region),
        .m_axi_aruser(host0_axil_128b_ar.user),
        .m_axi_arvalid(host0_axil_128b_arvalid),
        .m_axi_arready(host0_axil_128b_arready),
        .m_axi_rid(host0_axil_128b_r.id),
        .m_axi_rdata(host0_axil_128b_r.data),
        .m_axi_rresp(host0_axil_128b_r.resp),
        .m_axi_rlast(host0_axil_128b_r.last),
        .m_axi_ruser(host0_axil_128b_r.user),
        .m_axi_rvalid(host0_axil_128b_rvalid),
        .m_axi_rready(host0_axil_128b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_awready = host0_axil_32b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_wready = host0_axil_32b_wready;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_wready = host0_axil_32b_wready;
            end
    ...
    always_comb begin
        ...
        case (b_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_bid = host0_axil_32b_b.id;
                fub_axi_bresp = host0_axil_32b_b.resp;
                fub_axi_bvalid = host0_axil_32b_bvalid;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_bid = host0_axil_32b_b.id;
                fub_axi_bresp = host0_axil_32b_b.resp;
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_arready = host0_axil_32b_arready;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_arready = host0_axil_32b_arready;
            end
    ...
    always_comb begin
        ...
        case (r_slave_select)
            4'b0010: begin  // Slave 1 (32b)
                fub_axi_rid = host0_axil_32b_r.id;
                fub_axi_rdata = host0_axil_32b_r.data;
                fub_axi_rresp = host0_axil_32b_r.resp;
                fub_axi_rlast = host0_axil_32b_r.last;
                fub_axi_rvalid = host0_axil_32b_rvalid;
            end
            4'b0100: begin  // Slave 2 (32b)
                fub_axi_rid = host0_axil_32b_r.id;
                fub_axi_rdata = host0_axil_32b_r.data;
