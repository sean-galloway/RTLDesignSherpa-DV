...
#(
    ...
    output axi4_aw_t     dma_64b_aw,
    output logic         dma_64b_awvalid,
    input  logic         dma_64b_awready,

    output axi4_w_64b_t  dma_64b_w,
    output logic         dma_64b_wvalid,
    input  logic         dma_64b_wready,

    input  axi4_b_t      dma_64b_b,
    input  logic         dma_64b_bvalid,
    output logic         dma_64b_bready,

    output axi4_ar_t     dma_64b_ar,
    output logic         dma_64b_arvalid,
    input  logic         dma_64b_arready,

    input  axi4_r_64b_t  dma_64b_r,
    input  logic         dma_64b_rvalid,
    output logic         dma_64b_rready,
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[4] | comb_slave_select_aw[6]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[4] | w_slave_select[6];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[4] | comb_slave_select_ar[6]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[4] | b_slave_select[6];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[4] | r_slave_select[6];
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(dma_64b_aw.id),
        .m_axi_awaddr(dma_64b_aw.addr),
        .m_axi_awlen(dma_64b_aw.len),
        .m_axi_awsize(dma_64b_aw.size),
        .m_axi_awburst(dma_64b_aw.burst),
        .m_axi_awlock(dma_64b_aw.lock),
        .m_axi_awcache(dma_64b_aw.cache),
        .m_axi_awprot(dma_64b_aw.prot),
        .m_axi_awqos(dma_64b_aw.qos),
        .m_axi_awregion(dma_64b_aw.region),
        .m_axi_awuser(dma_64b_aw.user),
        .m_axi_awvalid(dma_64b_awvalid),
        .m_axi_awready(dma_64b_awready),
        .m_axi_wdata(dma_64b_w.data),
        .m_axi_wstrb(dma_64b_w.strb),
        .m_axi_wlast(dma_64b_w.last),
        .m_axi_wuser(dma_64b_w.user),
        .m_axi_wvalid(dma_64b_wvalid),
        .m_axi_wready(dma_64b_wready),
        .m_axi_bid(dma_64b_b.id),
        .m_axi_bresp(dma_64b_b.resp),
        .m_axi_buser(dma_64b_b.user),
        .m_axi_bvalid(dma_64b_bvalid),
        .m_axi_bready(dma_64b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma_64b_ar.id),
        .m_axi_araddr(dma_64b_ar.addr),
        .m_axi_arlen(dma_64b_ar.len),
        .m_axi_arsize(dma_64b_ar.size),
        .m_axi_arburst(dma_64b_ar.burst),
        .m_axi_arlock(dma_64b_ar.lock),
        .m_axi_arcache(dma_64b_ar.cache),
        .m_axi_arprot(dma_64b_ar.prot),
        .m_axi_arqos(dma_64b_ar.qos),
        .m_axi_arregion(dma_64b_ar.region),
        .m_axi_aruser(dma_64b_ar.user),
        .m_axi_arvalid(dma_64b_arvalid),
        .m_axi_arready(dma_64b_arready),
        .m_axi_rid(dma_64b_r.id),
        .m_axi_rdata(dma_64b_r.data),
        .m_axi_rresp(dma_64b_r.resp),
        .m_axi_rlast(dma_64b_r.last),
        .m_axi_ruser(dma_64b_r.user),
        .m_axi_rvalid(dma_64b_rvalid),
        .m_axi_rready(dma_64b_rready)
    );
