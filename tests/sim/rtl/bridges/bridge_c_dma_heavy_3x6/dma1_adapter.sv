// DMA1 Master Adapter Module
// Generated by: AdapterGenerator
// Handles timing isolation, address decode, and width conversion for dma1 master
...
#(
    ...
    // External AXI interface (from dma1 master)
    ...
    output axi4_aw_t     dma1_32b_aw,
    output logic         dma1_32b_awvalid,
    input  logic         dma1_32b_awready,

    output axi4_w_32b_t  dma1_32b_w,
    output logic         dma1_32b_wvalid,
    input  logic         dma1_32b_wready,

    input  axi4_b_t      dma1_32b_b,
    input  logic         dma1_32b_bvalid,
    output logic         dma1_32b_bready,

    output axi4_ar_t     dma1_32b_ar,
    output logic         dma1_32b_arvalid,
    input  logic         dma1_32b_arready,

    input  axi4_r_32b_t  dma1_32b_r,
    input  logic         dma1_32b_rvalid,
    output logic         dma1_32b_rready,

    output axi4_aw_t     dma1_64b_aw,
    output logic         dma1_64b_awvalid,
    input  logic         dma1_64b_awready,

    output axi4_w_64b_t  dma1_64b_w,
    output logic         dma1_64b_wvalid,
    input  logic         dma1_64b_wready,

    input  axi4_b_t      dma1_64b_b,
    input  logic         dma1_64b_bvalid,
    output logic         dma1_64b_bready,

    output axi4_ar_t     dma1_64b_ar,
    output logic         dma1_64b_arvalid,
    input  logic         dma1_64b_arready,

    input  axi4_r_64b_t  dma1_64b_r,
    input  logic         dma1_64b_rvalid,
    output logic         dma1_64b_rready,

    output axi4_aw_t     dma1_128b_aw,
    output logic         dma1_128b_awvalid,
    input  logic         dma1_128b_awready,

    output axi4_w_128b_t  dma1_128b_w,
    output logic         dma1_128b_wvalid,
    input  logic         dma1_128b_wready,

    input  axi4_b_t      dma1_128b_b,
    input  logic         dma1_128b_bvalid,
    output logic         dma1_128b_bready,

    output axi4_ar_t     dma1_128b_ar,
    output logic         dma1_128b_arvalid,
    input  logic         dma1_128b_arready,

    input  axi4_r_128b_t  dma1_128b_r,
    input  logic         dma1_128b_rvalid,
    output logic         dma1_128b_rready,

    output axi4_aw_t     dma1_256b_aw,
    output logic         dma1_256b_awvalid,
    input  logic         dma1_256b_awready,

    output axi4_w_256b_t  dma1_256b_w,
    output logic         dma1_256b_wvalid,
    input  logic         dma1_256b_wready,

    input  axi4_b_t      dma1_256b_b,
    input  logic         dma1_256b_bvalid,
    output logic         dma1_256b_bready,

    output axi4_ar_t     dma1_256b_ar,
    output logic         dma1_256b_arvalid,
    input  logic         dma1_256b_arready,

    input  axi4_r_256b_t  dma1_256b_r,
    input  logic         dma1_256b_rvalid,
    output logic         dma1_256b_rready
);
    ...
    assign aw_path_active_32b = (comb_slave_select_aw[4]) && aw_gate_ok;
    logic w_path_active_32b;
    assign w_path_active_32b = w_slave_select[4];
    logic ar_path_active_32b;
    assign ar_path_active_32b = (comb_slave_select_ar[4]) && ar_gate_ok;
    logic b_path_active_32b;
    assign b_path_active_32b = b_slave_select[4];
    logic r_path_active_32b;
    assign r_path_active_32b = r_slave_select[4];
    ...
    axi4_dwidth_converter_wr #(
        ...
        .m_axi_awid(dma1_32b_aw.id),
        .m_axi_awaddr(dma1_32b_aw.addr),
        .m_axi_awlen(dma1_32b_aw.len),
        .m_axi_awsize(dma1_32b_aw.size),
        .m_axi_awburst(dma1_32b_aw.burst),
        .m_axi_awlock(dma1_32b_aw.lock),
        .m_axi_awcache(dma1_32b_aw.cache),
        .m_axi_awprot(dma1_32b_aw.prot),
        .m_axi_awqos(dma1_32b_aw.qos),
        .m_axi_awregion(dma1_32b_aw.region),
        .m_axi_awuser(dma1_32b_aw.user),
        .m_axi_awvalid(dma1_32b_awvalid),
        .m_axi_awready(dma1_32b_awready),
        .m_axi_wdata(dma1_32b_w.data),
        .m_axi_wstrb(dma1_32b_w.strb),
        .m_axi_wlast(dma1_32b_w.last),
        .m_axi_wuser(dma1_32b_w.user),
        .m_axi_wvalid(dma1_32b_wvalid),
        .m_axi_wready(dma1_32b_wready),
        .m_axi_bid(dma1_32b_b.id),
        .m_axi_bresp(dma1_32b_b.resp),
        .m_axi_buser(dma1_32b_b.user),
        .m_axi_bvalid(dma1_32b_bvalid),
        .m_axi_bready(dma1_32b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma1_32b_ar.id),
        .m_axi_araddr(dma1_32b_ar.addr),
        .m_axi_arlen(dma1_32b_ar.len),
        .m_axi_arsize(dma1_32b_ar.size),
        .m_axi_arburst(dma1_32b_ar.burst),
        .m_axi_arlock(dma1_32b_ar.lock),
        .m_axi_arcache(dma1_32b_ar.cache),
        .m_axi_arprot(dma1_32b_ar.prot),
        .m_axi_arqos(dma1_32b_ar.qos),
        .m_axi_arregion(dma1_32b_ar.region),
        .m_axi_aruser(dma1_32b_ar.user),
        .m_axi_arvalid(dma1_32b_arvalid),
        .m_axi_arready(dma1_32b_arready),
        .m_axi_rid(dma1_32b_r.id),
        .m_axi_rdata(dma1_32b_r.data),
        .m_axi_rresp(dma1_32b_r.resp),
        .m_axi_rlast(dma1_32b_r.last),
        .m_axi_ruser(dma1_32b_r.user),
        .m_axi_rvalid(dma1_32b_rvalid),
        .m_axi_rready(dma1_32b_rready)
    );
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(dma1_64b_aw.id),
        .m_axi_awaddr(dma1_64b_aw.addr),
        .m_axi_awlen(dma1_64b_aw.len),
        .m_axi_awsize(dma1_64b_aw.size),
        .m_axi_awburst(dma1_64b_aw.burst),
        .m_axi_awlock(dma1_64b_aw.lock),
        .m_axi_awcache(dma1_64b_aw.cache),
        .m_axi_awprot(dma1_64b_aw.prot),
        .m_axi_awqos(dma1_64b_aw.qos),
        .m_axi_awregion(dma1_64b_aw.region),
        .m_axi_awuser(dma1_64b_aw.user),
        .m_axi_awvalid(dma1_64b_awvalid),
        .m_axi_awready(dma1_64b_awready),
        .m_axi_wdata(dma1_64b_w.data),
        .m_axi_wstrb(dma1_64b_w.strb),
        .m_axi_wlast(dma1_64b_w.last),
        .m_axi_wuser(dma1_64b_w.user),
        .m_axi_wvalid(dma1_64b_wvalid),
        .m_axi_wready(dma1_64b_wready),
        .m_axi_bid(dma1_64b_b.id),
        .m_axi_bresp(dma1_64b_b.resp),
        .m_axi_buser(dma1_64b_b.user),
        .m_axi_bvalid(dma1_64b_bvalid),
        .m_axi_bready(dma1_64b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma1_64b_ar.id),
        .m_axi_araddr(dma1_64b_ar.addr),
        .m_axi_arlen(dma1_64b_ar.len),
        .m_axi_arsize(dma1_64b_ar.size),
        .m_axi_arburst(dma1_64b_ar.burst),
        .m_axi_arlock(dma1_64b_ar.lock),
        .m_axi_arcache(dma1_64b_ar.cache),
        .m_axi_arprot(dma1_64b_ar.prot),
        .m_axi_arqos(dma1_64b_ar.qos),
        .m_axi_arregion(dma1_64b_ar.region),
        .m_axi_aruser(dma1_64b_ar.user),
        .m_axi_arvalid(dma1_64b_arvalid),
        .m_axi_arready(dma1_64b_arready),
        .m_axi_rid(dma1_64b_r.id),
        .m_axi_rdata(dma1_64b_r.data),
        .m_axi_rresp(dma1_64b_r.resp),
        .m_axi_rlast(dma1_64b_r.last),
        .m_axi_ruser(dma1_64b_r.user),
        .m_axi_rvalid(dma1_64b_rvalid),
        .m_axi_rready(dma1_64b_rready)
    );

    // ================================================================
    // Direct passthrough: 128b → 128b (no converter)
    // Requests: fub_axi_* → dma1_128b_*
    // Responses: dma1_128b_* → MUX → fub_axi_*
    // ================================================================

    // AW channel (request: fub → output)
    assign dma1_128b_aw.id     = fub_axi_awid;
    assign dma1_128b_aw.addr   = fub_axi_awaddr;
    assign dma1_128b_aw.len    = fub_axi_awlen;
    assign dma1_128b_aw.size   = fub_axi_awsize;
    assign dma1_128b_aw.burst  = fub_axi_awburst;
    assign dma1_128b_aw.lock   = fub_axi_awlock;
    assign dma1_128b_aw.cache  = fub_axi_awcache;
    assign dma1_128b_aw.prot   = fub_axi_awprot;
    assign dma1_128b_aw.qos    = 4'b0;  // Tie to 0
    assign dma1_128b_aw.region = 4'b0;  // Tie to 0
    assign dma1_128b_aw.user   = 1'b0;  // Tie to 0
    assign dma1_128b_awvalid   = fub_axi_awvalid && aw_path_active_128b;
    // awready routed via MUX

    // W channel (request: fub → output)
    assign dma1_128b_w.data  = fub_axi_wdata;
    assign dma1_128b_w.strb  = fub_axi_wstrb;
    assign dma1_128b_w.last  = fub_axi_wlast;
    assign dma1_128b_w.user  = 1'b0;  // Tie to 0
    assign dma1_128b_wvalid  = fub_axi_wvalid && w_path_active_128b;
    // wready routed via MUX

    // B channel (response: output → MUX → fub)
    // Ready gated by the response head — see b_path_active comment.
    assign dma1_128b_bready = fub_axi_bready && b_path_active_128b;
    // bid, bresp, bvalid routed via MUX (user field ignored)

    // AR channel (request: fub → output)
    assign dma1_128b_ar.id     = fub_axi_arid;
    assign dma1_128b_ar.addr   = fub_axi_araddr;
    assign dma1_128b_ar.len    = fub_axi_arlen;
    assign dma1_128b_ar.size   = fub_axi_arsize;
    assign dma1_128b_ar.burst  = fub_axi_arburst;
    assign dma1_128b_ar.lock   = fub_axi_arlock;
    assign dma1_128b_ar.cache  = fub_axi_arcache;
    assign dma1_128b_ar.prot   = fub_axi_arprot;
    assign dma1_128b_ar.qos    = 4'b0;  // Tie to 0
    assign dma1_128b_ar.region = 4'b0;  // Tie to 0
    assign dma1_128b_ar.user   = 1'b0;  // Tie to 0
    assign dma1_128b_arvalid   = fub_axi_arvalid && ar_path_active_128b;
    // arready routed via MUX

    // R channel (response: output → MUX → fub)
    // Ready gated by the response head — see r_path_active comment.
    assign dma1_128b_rready = fub_axi_rready && r_path_active_128b;
    ...
    axi4_dwidth_converter_wr #(
        ...
        // Master side (to crossbar)
        .m_axi_awid(dma1_256b_aw.id),
        .m_axi_awaddr(dma1_256b_aw.addr),
        .m_axi_awlen(dma1_256b_aw.len),
        .m_axi_awsize(dma1_256b_aw.size),
        .m_axi_awburst(dma1_256b_aw.burst),
        .m_axi_awlock(dma1_256b_aw.lock),
        .m_axi_awcache(dma1_256b_aw.cache),
        .m_axi_awprot(dma1_256b_aw.prot),
        .m_axi_awqos(dma1_256b_aw.qos),
        .m_axi_awregion(dma1_256b_aw.region),
        .m_axi_awuser(dma1_256b_aw.user),
        .m_axi_awvalid(dma1_256b_awvalid),
        .m_axi_awready(dma1_256b_awready),
        .m_axi_wdata(dma1_256b_w.data),
        .m_axi_wstrb(dma1_256b_w.strb),
        .m_axi_wlast(dma1_256b_w.last),
        .m_axi_wuser(dma1_256b_w.user),
        .m_axi_wvalid(dma1_256b_wvalid),
        .m_axi_wready(dma1_256b_wready),
        .m_axi_bid(dma1_256b_b.id),
        .m_axi_bresp(dma1_256b_b.resp),
        .m_axi_buser(dma1_256b_b.user),
        .m_axi_bvalid(dma1_256b_bvalid),
        .m_axi_bready(dma1_256b_bready)
    );
    ...
    axi4_dwidth_converter_rd #(
        ...
        // Master side (to crossbar)
        .m_axi_arid(dma1_256b_ar.id),
        .m_axi_araddr(dma1_256b_ar.addr),
        .m_axi_arlen(dma1_256b_ar.len),
        .m_axi_arsize(dma1_256b_ar.size),
        .m_axi_arburst(dma1_256b_ar.burst),
        .m_axi_arlock(dma1_256b_ar.lock),
        .m_axi_arcache(dma1_256b_ar.cache),
        .m_axi_arprot(dma1_256b_ar.prot),
        .m_axi_arqos(dma1_256b_ar.qos),
        .m_axi_arregion(dma1_256b_ar.region),
        .m_axi_aruser(dma1_256b_ar.user),
        .m_axi_arvalid(dma1_256b_arvalid),
        .m_axi_arready(dma1_256b_arready),
        .m_axi_rid(dma1_256b_r.id),
        .m_axi_rdata(dma1_256b_r.data),
        .m_axi_rresp(dma1_256b_r.resp),
        .m_axi_rlast(dma1_256b_r.last),
        .m_axi_ruser(dma1_256b_r.user),
        .m_axi_rvalid(dma1_256b_rvalid),
        .m_axi_rready(dma1_256b_rready)
    );
    ...
    always_comb begin
        ...
        case (comb_slave_select_aw)
            ...
            6'b000010: begin  // Slave 1 (128b)
                fub_axi_awready = dma1_128b_awready;
            end
    ...
    always_comb begin
        ...
        case (w_slave_select)
            ...
            6'b000010: begin  // Slave 1 (128b)
                fub_axi_wready = dma1_128b_wready;
            end
            6'b000001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (b_slave_select)
            ...
            6'b000010: begin  // Slave 1 (128b)
                fub_axi_bid = dma1_128b_b.id;
                fub_axi_bresp = dma1_128b_b.resp;
                fub_axi_bvalid = dma1_128b_bvalid;
            end
            6'b000001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (comb_slave_select_ar)
            ...
            6'b000010: begin  // Slave 1 (128b)
                fub_axi_arready = dma1_128b_arready;
            end
            6'b000001: begin  // Slave 0 (256b)
    ...
    always_comb begin
        ...
        case (r_slave_select)
            ...
            6'b000010: begin  // Slave 1 (128b)
                fub_axi_rid = dma1_128b_r.id;
                fub_axi_rdata = dma1_128b_r.data;
                fub_axi_rresp = dma1_128b_r.resp;
                fub_axi_rlast = dma1_128b_r.last;
                fub_axi_rvalid = dma1_128b_rvalid;
            end
            6'b000001: begin  // Slave 0 (256b)
